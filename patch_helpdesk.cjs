...
const replacement = `// Client-side API handler for Help Desk / Zammad
...
fs.writeFileSync('src/services/helpdeskApi.ts', replacement, 'utf8');
console.log('Helpdesk Api patched');
