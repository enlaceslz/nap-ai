          ...
          <button 
            ...
            className={`p-5 rounded-2xl border flex items-center gap-4 text-left transition-all ${
              kpiFilter === 'todos' 
                ...
                : 'bg-slate-900 border-white/5 hover:bg-slate-800/80 hover:border-white/10'
            }`}
          >
          ...
          <div className="bg-slate-900 border border-white/10 rounded-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2 md:col-span-1">
                  <label className="block text-[11px] font-bold uppercase tracking-wider text-slate-500 mb-1.5">Ramal SIP (Asterisk 20+)</label>
                  <input 
                    type="text" 
