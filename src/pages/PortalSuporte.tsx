...
export default function PortalSuporte() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto w-full pb-24">
      ...
      <div className="bg-gradient-to-r from-slate-900 to-indigo-950 p-6 rounded-3xl text-white mb-8 border border-indigo-900/50 relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-sm">
            ...
            <form onSubmit={handleCriarChamado} className="space-y-4 pt-4">
              ...
              <div className="flex items-start gap-3 p-3 bg-slate-50 border border-slate-200 rounded-xl">
                <input
                  ...
                  className="mt-0.5 w-4 h-4 text-blue-600 bg-white border-slate-300 rounded focus:ring-blue-500 focus:ring-2 cursor-pointer"
                />
                <label htmlFor="enviarGps" className="text-[11px] font-medium text-slate-700 cursor-pointer flex-1 leading-tight">
                  <span className="font-bold text-slate-900 block mb-0.5">Enviar Minha Localização Atual</span>
