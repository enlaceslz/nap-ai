        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-16">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#0a50ff] to-[#55b0ff] flex items-center justify-center shadow-[0_2px_10px_rgba(10,80,255,0.4)]">
              <span className="text-white font-black text-2xl tracking-tight font-sans mt-[1px]">N</span>
            </div>
            <span className="font-bold text-2xl text-white tracking-tight font-outfit">NAP <span className="text-[#55b0ff] font-bold text-xs uppercase tracking-wider bg-[#0a50ff]/15 border border-[#0a50ff]/30 px-2 py-1 rounded ml-1">Omni</span></span>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        <div className="w-full max-w-md">
          <div className="lg:hidden flex items-center gap-2 mb-12 justify-center">
            ...
            <span className="font-bold text-xl text-slate-900 tracking-tight font-outfit">NAP <span className="text-[#0a50ff] font-bold text-[10px] uppercase tracking-wider bg-blue-50 border border-blue-200 px-1.5 py-0.5 rounded ml-1">Omni</span></span>
          </div>
