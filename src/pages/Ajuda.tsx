...
export default function Ajuda() {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      default: return <Circle size={20} className="text-slate-600" />;
    }
  };
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex gap-4 border-b border-slate-800 pb-px">
        <button 
          ...
          className={`pb-3 px-1 font-medium transition-colors border-b-2 ${activeTab === 'matriz' ? 'border-blue-500 text-blue-400' : 'border-transparent text-slate-400 hover:text-slate-300'}`}
        >
          <div className="flex items-center gap-2"><CheckCircle2 size={18} /> Matriz de Homologação (UAT)</div>
        </button>
        <button 
          onClick={() => setActiveTab('manuais')}
          className={`pb-3 px-1 font-medium transition-colors border-b-2 ${activeTab === 'manuais' ? 'border-blue-500 text-blue-400' : 'border-transparent text-slate-400 hover:text-slate-300'}`}
        >
          <div className="flex items-center gap-2"><FileText size={18} /> Guias Operacionais</div>
        </button>
        <button 
          onClick={() => setActiveTab('deploy')}
          className={`pb-3 px-1 font-medium transition-colors border-b-2 ${activeTab === 'deploy' ? 'border-blue-500 text-blue-400' : 'border-transparent text-slate-400 hover:text-slate-300'}`}
        >
      ...
      <div className="mt-6">
        {activeTab === 'matriz' && (
          <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden shadow-sm">
            <div className="p-5 border-b border-slate-800 bg-slate-800/30 flex justify-between items-center">
              <div>
                <h2 className="text-lg font-semibold text-slate-200">Prontidão do Sistema (Staging / Production)</h2>
                <p className="text-sm text-slate-400 mt-1">Status de aprovação técnica e implantação dos módulos arquitetônicos.</p>
              </div>
              ...
              {matrixStaging.map((item, i) => (
                <div key={i} className="p-4 hover:bg-slate-800/30 transition-colors flex items-center justify-between">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-medium text-slate-200">{item.module}</h3>
        ...
        {activeTab === 'manuais' && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl hover:border-blue-500/50 transition-colors cursor-pointer group">
              ...
              <h3 className="text-lg font-semibold text-slate-200 mb-2">Treinamento WABA & Gemini</h3>
            ...
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl hover:border-emerald-500/50 transition-colors cursor-pointer group">
              ...
              <h3 className="text-lg font-semibold text-slate-200 mb-2">Auditoria Drizzle & DB</h3>
              <p className="text-slate-400 text-sm mb-4 leading-relaxed">
            ...
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl hover:border-purple-500/50 transition-colors cursor-pointer group">
              ...
              <h3 className="text-lg font-semibold text-slate-200 mb-2">Multi-ERP Hub</h3>
              <p className="text-slate-400 text-sm mb-4 leading-relaxed">
             ...
             <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl hover:border-indigo-500/50 transition-colors cursor-pointer group">
              ...
              <h3 className="text-lg font-semibold text-slate-200 mb-2">PWA & Field Service</h3>
              <p className="text-slate-400 text-sm mb-4 leading-relaxed">
        ...
        {activeTab === 'deploy' && (
          <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden p-8 text-center max-w-3xl mx-auto mt-8">
             ...
             <h2 className="text-2xl font-bold text-slate-200 mb-4">Deploy em Produção (Debian 12)</h2>
             ...
             <div className="flex justify-center gap-4">
                ...
                <button className="bg-slate-800 hover:bg-slate-700 text-slate-200 px-6 py-2.5 border border-slate-700 rounded-lg font-medium transition-colors">
