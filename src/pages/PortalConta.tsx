        ...
        <div className="bg-white rounded-3xl border border-slate-200 overflow-hidden relative">
          <div className="p-5 md:p-6 border-b border-slate-200 bg-white flex items-center justify-between relative z-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-slate-900 font-outfit">Contrato & Adesão Digital</h2>
                <p className="text-xs text-slate-500">Termo de adesão SCM, fidelidade e comodato de equipamentos.</p>
              </div>
            </div>
            <span className="px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200 text-[10px] font-bold uppercase tracking-wider flex items-center gap-1">
          ...
          <div className="p-5 md:p-6 space-y-4 relative z-10">
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 flex flex-col sm:flex-row justify-between sm:items-center gap-3">
              <div>
                <p className="text-xs text-slate-400 font-bold uppercase tracking-wider">Número do Contrato</p>
                <p className="text-base font-bold font-mono text-slate-900">{clientData.contrato || 'CTR-2026-8894'}</p>
                <p className="text-xs text-slate-500 mt-0.5">Plano: {clientData.plano} • Fidelidade: 12 meses</p>
              </div>
              <button
                type="button"
