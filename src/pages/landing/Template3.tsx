...
export default function Template3({ config: propsConfig }: TemplateProps) {
 ...
 return (
 <div className="min-h-screen bg-background text-foreground font-outfit selection:bg-emerald-500/20">
 {/* Header */}
 ...
 <span className="font-bold text-2xl tracking-tight text-foreground font-outfit">{nomeProvedor}</span>
 </div>
 )}
 </Link>
 ...
 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 text-foreground max-w-4xl mx-auto"
 >
 {tituloHero}
 </motion.h1>
 ...
 <Link to="/portal" className="bg-card text-muted-foreground border border-border hover:border-emerald-300 px-8 py-4 rounded-full font-bold text-lg hover:bg-background transition-all flex items-center justify-center gap-2">
 ...
 className="mt-16 max-w-5xl mx-auto bg-card rounded-3xl border border-border shadow-xl overflow-hidden relative h-[360px]"
 id="vantagens"
 >
 ...
 <Home size={28} className="text-foreground" />
 </div>
 <span className="font-bold text-sm sm:text-base">Casa Inteligente</span>
 </div>
 <div className="flex flex-col items-center gap-3 text-foreground sm:mt-8">
 <div className="w-14 h-14 sm:w-16 sm:h-16 bg-white/20 backdrop-blur-md rounded-2xl border border-white/30 flex items-center justify-center shadow-lg">
 <Wifi size={28} className="text-foreground" />
 </div>
 <span className="font-bold text-sm sm:text-base">Wi-Fi Total Estável</span>
 </div>
 <div className="flex flex-col items-center gap-3 text-foreground">
 <div className="w-14 h-14 sm:w-16 sm:h-16 bg-white/20 backdrop-blur-md rounded-2xl border border-white/30 flex items-center justify-center shadow-lg">
 <Tv size={28} className="text-foreground" />
 </div>
 ...
 {/* Pricing */}
 <section className="py-24 px-6 bg-card border-t border-slate-100" id="planos">
 <div className="max-w-7xl mx-auto">
 <div className="text-center mb-16">
 <h2 className="text-4xl font-bold mb-4 text-foreground">Planos {nomeProvedor}</h2>
 <p className="text-muted-foreground text-lg">Sem surpresas. Preço fixo e instalação gratuita.</p>
 </div>
 ...
 <div 
 key={i}
 className={`bg-card rounded-3xl p-8 border ${plan.highlight ? 'border-emerald-500 shadow-xl shadow-emerald-500/10 ring-2 ring-emerald-500/20' : 'border-border shadow-sm'} flex flex-col`}
 >
 {plan.highlight && (
 ...
 <span className="text-lg font-bold text-muted-foreground">Mega</span>
 </div>
 ...
 target="_blank"
 rel="noreferrer"
 className={`w-full py-4 rounded-xl font-bold transition-all text-center block ${plan.highlight ? 'bg-emerald-600 hover:bg-emerald-700 text-white shadow-md shadow-emerald-600/30' : 'bg-slate-100 hover:bg-slate-200 text-foreground'}`}
 >
 Quero este plano
 </a>
 </div>
