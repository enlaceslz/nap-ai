...
export default function Template1({ config: propsConfig }: TemplateProps) {
  ...
  return (
    <div className="relative min-h-screen bg-slate-950 text-white font-outfit overflow-x-hidden selection:bg-blue-500/30" style={{ backgroundImage: `url(https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=2000&auto=format&fit=crop)`, backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed" }}>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <motion.div 
                  ...
                  className="bg-slate-950 border border-white/5 p-8 rounded-3xl hover:border-blue-500/30 transition-colors group"
                >
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {planos.map((plan, i) => (
                ...
                >
                  ...
                  <div className="bg-slate-950 rounded-[22px] p-8 h-full flex flex-col">
