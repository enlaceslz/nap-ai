...
export default function Telefonia() {
 ...
 <p className="text-sm text-muted-foreground mt-0.5">Monitoramento CTI e Estúdio de URA Visual</p>
 </div>
 </div>
 </div>
 ...
 <p className="text-3xl font-bold text-foreground font-outfit mb-1">{activeCalls.length}</p>
 <p className="text-xs text-muted-foreground uppercase tracking-wider font-bold">Chamadas Ativas</p>
 </div>
 ...
 <p className="text-xs text-muted-foreground uppercase tracking-wider font-bold">Em Fila de Espera</p>
 </div>
 ...
 <p className="text-xs text-muted-foreground uppercase tracking-wider font-bold">Em Atendimento</p>
 </div>
 ...
 <p className="text-xs text-muted-foreground uppercase tracking-wider font-bold">Retidas na IA</p>
 </div>
 </div>
 ...
 className="pl-9 pr-4 py-1.5 bg-background border border-border rounded-lg text-sm text-foreground focus:ring-2 focus:ring-blue-500 outline-none w-48"
 />
 </div>
 </div>
 </div>
 ...
 <tr key={call.id} className="hover:bg-accent transition-colors group">
 <td className="px-6 py-4 font-mono text-xs">{call.id}</td>
 <td className="px-6 py-4 font-bold text-foreground">{call.caller}</td>
 ...
 <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-widest mb-4">Componentes</h3>
 
 <div className="space-y-2">
 <div className="p-3 bg-background border border-border rounded-xl flex items-center gap-3 cursor-grab hover:border-indigo-500/50 transition-colors">
 <div className="w-8 h-8 rounded-lg bg-indigo-500/10 text-indigo-400 flex items-center justify-center">
 <ListMenu size={16} />
 </div>
 <div className="text-sm font-bold text-muted-foreground">Menu DTMF</div>
 </div>

 <div className="p-3 bg-background border border-border rounded-xl flex items-center gap-3 cursor-grab hover:border-emerald-500/50 transition-colors">
 <div className="w-8 h-8 rounded-lg bg-emerald-500/10 text-emerald-400 flex items-center justify-center">
 <Users size={16} />
 </div>
 <div className="text-sm font-bold text-muted-foreground">Fila (Queue)</div>
 </div>

 <div className="p-3 bg-background border border-border rounded-xl flex items-center gap-3 cursor-grab hover:border-purple-500/50 transition-colors">
 <div className="w-8 h-8 rounded-lg bg-purple-500/10 text-purple-400 flex items-center justify-center">
 <Bot size={16} />
 </div>
 <div className="text-sm font-bold text-muted-foreground">Agente IA (MaIA)</div>
 </div>

 <div className="p-3 bg-background border border-border rounded-xl flex items-center gap-3 cursor-grab hover:border-amber-500/50 transition-colors">
 <div className="w-8 h-8 rounded-lg bg-amber-500/10 text-amber-400 flex items-center justify-center">
 <Volume2 size={16} />
 </div>
 <div className="text-sm font-bold text-muted-foreground">Tocar Áudio</div>
 </div>
 </div>
 </div>
 ...
 {/* Canvas da URA */}
 <div className="flex-1 bg-background/50 border border-border rounded-2xl relative min-h-[500px] overflow-hidden shadow-inner flex flex-col items-center p-8 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAiIGhlaWdodD0iMjAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMiIgY3k9IjIiIHI9IjEiIGZpbGw9InJnYmEoMjU1LDI1NSwyNTUsMC4wNSkiLz48L3N2Zz4=')]">
 
 {/* INICIO */}
 <div className="bg-muted text-foreground px-6 py-2 rounded-full font-bold text-sm shadow-lg mb-8 border border-border z-10">
 Chamada Recebida (0800 591 0000)
 </div>

 {/* Seta */}
 <div className="w-0.5 h-8 bg-accent -mt-8 mb-2 z-0"></div>

 {/* Nó Principal URA */}
 <div className="w-full max-w-sm bg-card border border-indigo-500/30 rounded-2xl shadow-xl overflow-hidden z-10 relative">
 ...
 <button className="text-muted-foreground hover:text-foreground transition-colors"><Edit3 size={14}/></button>
 </div>
 </div>
 ...
 <p className="text-xs text-muted-foreground font-bold uppercase tracking-wider mb-0.5">Áudio de Saudação</p>
 <p className="text-sm text-card-foreground truncate">bem_vindo_nap.wav</p>
 </div>
 </div>

 <div className="space-y-2">
 <div className="flex items-center gap-2">
 <div className="w-6 h-6 rounded-md bg-muted border border-border flex items-center justify-center text-xs font-mono font-bold text-muted-foreground">1</div>
 <div className="flex-1 h-9 rounded-lg border border-border bg-background flex items-center px-3 text-sm text-muted-foreground">
 <Users size={14} className="text-emerald-400 mr-2" /> Fila: Suporte N1
 </div>
 </div>
 <div className="flex items-center gap-2">
 <div className="w-6 h-6 rounded-md bg-muted border border-border flex items-center justify-center text-xs font-mono font-bold text-muted-foreground">2</div>
 <div className="flex-1 h-9 rounded-lg border border-border bg-background flex items-center px-3 text-sm text-muted-foreground">
 <Users size={14} className="text-emerald-400 mr-2" /> Fila: Financeiro
 </div>
 </div>
 <div className="flex items-center gap-2">
 <div className="w-6 h-6 rounded-md bg-muted border border-border flex items-center justify-center text-xs font-mono font-bold text-muted-foreground">3</div>
 ...
 <div className="w-6 h-6 rounded-md bg-muted border border-border flex items-center justify-center text-xs font-mono font-bold text-muted-foreground">t</div>
 <div className="flex-1 h-9 rounded-lg border border-border bg-background/50 flex items-center px-3 text-xs text-muted-foreground italic">
 ...
 <h3 className="font-bold text-lg text-foreground font-outfit">Gerenciador de Áudios (TTS & Gravados)</h3>
 ...
 <div key={i} className="bg-card border border-border rounded-2xl p-4 shadow-lg group hover:border-border transition-colors">
 <div className="flex justify-between items-start mb-3">
 <div className="w-10 h-10 rounded-xl bg-indigo-500/10 text-indigo-400 flex items-center justify-center">
 <FileAudio size={18} />
 </div>
 <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
 <button className="p-1.5 text-muted-foreground hover:text-foreground bg-muted rounded-lg"><Edit3 size={14}/></button>
 <button className="p-1.5 text-red-400 hover:text-foreground bg-muted rounded-lg"><Trash2 size={14}/></button>
 </div>
 </div>
 <p className="font-bold text-foreground text-sm mb-1">{audio}</p>
 <p className="text-xs text-muted-foreground mb-4">Atualizado há {i+1} dias</p>
 ...
 <span className="text-[10px] text-muted-foreground font-mono">0:00 / 0:14</span>
 </div>
 </div>
 ))}
 ...
 <h4 className="font-bold text-foreground text-sm mb-1">Gerar Áudio com Gemini</h4>
 ...
 <div className="flex justify-between items-center">
 <div>
 <h3 className="font-bold text-lg text-foreground font-outfit">Assistente de Criação de Ramais (SIP)</h3>
 ...
 <thead>
 <tr className="bg-background/50 border-b border-border text-xs uppercase tracking-wider text-muted-foreground font-bold">
 ...
 {ramais.map((ramal) => (
 <tr key={ramal.id} className="border-b border-border hover:bg-accent transition-colors">
 <td className="p-4">
 <div className="flex items-center gap-2">
 ...
 <span className={ramal.status === 'online' ? 'text-emerald-400 font-medium text-xs uppercase tracking-wider' : 'text-muted-foreground font-medium text-xs uppercase tracking-wider'}>
 {ramal.status}
 </span>
 </div>
 </td>
 <td className="p-4 font-bold text-foreground font-mono">{ramal.id}</td>
 <td className="p-4 text-muted-foreground font-medium">{ramal.nome}</td>
 <td className="p-4">
 <div className="flex items-center gap-2">
 <span className="text-muted-foreground font-mono tracking-widest">{ramal.senha}</span>
 </div>
 </td>
 <td className="p-4 text-right flex items-center justify-end gap-2">
 <button className="p-2 text-muted-foreground hover:text-foreground bg-background hover:bg-muted rounded-lg transition-colors" title="Editar">
 <Edit3 size={16} />
 </button>
 <button className="p-2 text-red-400 hover:text-white bg-background hover:bg-red-500/20 rounded-lg transition-colors" title="Remover">
 <Trash2 size={16} />
 </button>
 </td>
 </tr>
 ...
 <div className="bg-card border border-border rounded-2xl w-full max-w-md overflow-hidden shadow-2xl flex flex-col animate-in fade-in zoom-in-95 duration-200">
 <div className="p-4 border-b border-border flex items-center justify-between bg-background">
 <h3 className="font-bold text-foreground flex items-center gap-2">
 <Hash className="text-blue-400" size={18} />
 Novo Ramal Asterisk
 </h3>
 <button onClick={() => setShowRamalModal(false)} className="p-1.5 text-muted-foreground hover:text-foreground rounded-lg hover:bg-accent">
 ...
 <div>
 <label className="block text-xs font-bold uppercase tracking-wider text-muted-foreground mb-1.5">Número do Ramal</label>
 <input 
 type="text" 
 ...
 <div>
 <label className="block text-xs font-bold uppercase tracking-wider text-muted-foreground mb-1.5">Nome / Identificação</label>
 <input 
 type="text" 
 ...
 <div>
 <label className="block text-xs font-bold uppercase tracking-wider text-muted-foreground mb-1.5">Secret (Senha SIP)</label>
 <input 
 type="text" 
 ...
 className="w-full p-2.5 bg-background border border-border rounded-xl text-sm font-medium text-foreground outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600" 
 />
 <p className="text-[11px] text-muted-foreground mt-1">Utilize senhas fortes para ramais expostos externamente.</p>
 </div>
 </div>

 <div className="p-4 bg-background border-t border-border flex justify-end gap-3">
 <button onClick={() => setShowRamalModal(false)} className="px-4 py-2 text-sm font-bold text-muted-foreground hover:text-foreground transition-colors">
 Cancelar
 </button>
 <button 
 onClick={() => {
