        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-slate-900 p-6 rounded-2xl border border-white/5">
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            <button
              ...
              disabled={saving}
              type="button"
              className="px-4 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 active:scale-95 text-white rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 shadow-md shadow-blue-500/20"
          ...
          <div className="p-6 md:p-8">
            ...
            {activeTab === 'infraestrutura' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="p-5 bg-slate-900 border border-white/5 rounded-2xl space-y-4 shadow-lg shadow-black/20">
                    <div className="flex items-center gap-3 border-b border-white/5 pb-4">
                      <div className="w-10 h-10 rounded-xl bg-blue-500/10 text-blue-400 flex items-center justify-center">
                        <LayoutTemplate size={20} />
                      </div>
                      <div>
                        <h4 className="font-bold text-white text-sm">Domínio da Landing Page</h4>
                        <p className="text-[11px] text-slate-400">URL pública principal (Portal e Vendas)</p>
                      </div>
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                        <input 
                          ...
                          placeholder="https://naptelecom.com.br"
                          className="w-full p-2.5 bg-slate-950 border border-white/5 rounded-xl text-sm font-medium text-white outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 transition-all" 
                        />
                        <button 
                          onClick={() => runSslTest('landingPage', config.infraestrutura?.dominioLandingPage || '')}
                          disabled={testing['ssl_landingPage']}
                          className="bg-slate-800 hover:bg-slate-700 text-blue-400 p-2.5 rounded-xl transition-colors border border-white/5 disabled:opacity-50"
                  ...
                  <div className="p-5 bg-slate-900 border border-white/5 rounded-2xl space-y-4 shadow-lg shadow-black/20">
                    <div className="flex items-center gap-3 border-b border-white/5 pb-4">
                      ...
                      <div>
                        <h4 className="font-bold text-white text-sm">IP Público (NAT/Firewall)</h4>
                        <p className="text-[11px] text-slate-400">Usado para SIP/RTP WebRTC e Callbacks</p>
                      </div>
                    </div>
                    <div>
                      <input 
                        ...
                        className="w-full p-2.5 bg-slate-950 border border-white/5 rounded-xl text-sm font-medium text-white outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-600 transition-all font-mono" 
                      />
                    </div>
                  </div>
                  ...
                  <div className="p-5 bg-slate-900 border border-white/5 rounded-2xl space-y-4 shadow-lg shadow-black/20">
                    <div className="flex items-center gap-3 border-b border-white/5 pb-4">
                      ...
                      <div>
                        <h4 className="font-bold text-white text-sm">IP Privado (TR-069)</h4>
                        <p className="text-[11px] text-slate-400">Faixa de gerência para equipamentos</p>
                      </div>
                    </div>
                    <div>
                      <input 
                        ...
                        className="w-full p-2.5 bg-slate-950 border border-white/5 rounded-xl text-sm font-medium text-white outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-600 transition-all font-mono" 
                      />
                    </div>
                  </div>
                </div>
            ...
            {activeTab === 'sgp' && (
              <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
                ...
                <h2 className="text-xl font-bold text-white mb-2">Multi-ERP Hub Movido</h2>
            ...
            {activeTab === 'whatsapp' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-wider text-slate-400 mb-1.5">Regra de Envio Financeiro via WhatsApp</label>
                    <label className="flex items-center gap-3 p-3 bg-slate-950 border border-white/5 rounded-xl cursor-pointer mb-2">
                      <input 
                        type="checkbox" 
                      ...
                      />
                      <span className="text-xs font-bold text-slate-200">Gerar PIX e PDF quando o cliente solicitar "2ª via" no WhatsApp</span>
                    </label>
                  </div>
                </div>
                ...
                <div className="p-5 bg-gradient-to-br from-blue-950/40 via-slate-900 to-indigo-950/30 border border-blue-500/20 rounded-2xl space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <h4 className="text-sm font-bold text-white font-outfit">Canal Principal: Portal do Assinante (PWA / Web)</h4>
                        <p className="text-xs text-slate-400">Notificações, cobrança e autoatendimento centralizados no app do cliente.</p>
                      </div>
                    </div>
                  ...
                  <p className="text-xs text-slate-300 leading-relaxed">
                    O NAP adota o <strong>Portal do Cliente</strong> como canal primário oficial para notificações (Push Web), consulta de faturas, pagamento via PIX instantâneo e abertura de tickets de suporte. Essa abordagem reduz drasticamente os custos com tarifas da Meta (WABA) e fortalece a identidade do provedor.
                  </p>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1">
                    <div className="bg-slate-950/80 p-3.5 rounded-xl border border-white/5 space-y-2">
                      <label className="block text-xs font-bold text-slate-300">Envio de Faturas via WhatsApp</label>
                      <select 
                        ...
                        className="w-full p-2 bg-slate-900 border border-white/10 rounded-lg text-xs font-semibold text-white outline-none focus:border-blue-500"
                      >
                    ...
                    <div className="bg-slate-950/80 p-3.5 rounded-xl border border-white/5 space-y-2">
                      <label className="block text-xs font-bold text-slate-300">Envio de Informativos & Avisos de Rede</label>
                      <select 
                ...
                <div className="p-5 bg-gradient-to-br from-emerald-950/30 via-slate-900 to-indigo-950/20 border border-emerald-500/20 rounded-2xl space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <h4 className="text-sm font-bold text-white font-outfit">Atendimento 24h no WhatsApp via MaIA (Após Homologação)</h4>
                        <p className="text-xs text-slate-400">Canal sempre aberto com IA humanizada e transição humana instantânea.</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <label className="flex items-start gap-3 p-3.5 bg-slate-950/80 border border-white/5 rounded-xl cursor-pointer hover:border-emerald-500/30 transition-all">
                      <input 
                        type="checkbox" 
                      ...
                      />
                      <div>
                        <span className="text-xs font-bold text-white block">Atendimento Inteligente 24h com MaIA</span>
                    ...
                    <label className="flex items-start gap-3 p-3.5 bg-slate-950/80 border border-white/5 rounded-xl cursor-pointer hover:border-emerald-500/30 transition-all">
                      ...
                      />
                      <div>
                        <span className="text-xs font-bold text-white block">Interatividade Humana a Qualquer Momento</span>
                        <span className="text-[11px] text-slate-400 leading-relaxed block mt-0.5">
            ...
            {activeTab === 'telegram' && (
              <div className="space-y-6 animate-in fade-in duration-300">
                <div className="flex justify-between items-start">
                  <div>
                    <h2 className="text-xl font-bold text-white font-outfit">Communications Hub (Telegram)</h2>
                    <p className="text-sm text-slate-400 mt-1">Integração Omni-direcional de Notificações NOC e Copilot</p>
                  </div>
                  <button 
                    onClick={() => {
                ...
                <div className="bg-slate-900 border border-white/10 rounded-2xl p-6">
                  <h3 className="font-bold text-white mb-4">Arquitetura de Notificações</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-slate-950 p-4 rounded-xl border border-white/5">
                      <div className="font-bold text-slate-300 mb-2">Telegram Gateway</div>
                      <p className="text-xs text-slate-500">
                        Opera sem regras de negócio (PRD #8). Recebe o webhook, valida a integridade e envia os callbacks para a API do NAP, que realiza a segurança e orquestração.
                      </p>
                    </div>
                    <div className="bg-slate-950 p-4 rounded-xl border border-white/5">
                      <div className="font-bold text-slate-300 mb-2">RBAC & Identidade</div>
                      <p className="text-xs text-slate-500">
                        O ID do Telegram nunca é aceito sem um vínculo formal no NAP. Qualquer permissão de leitura de Zabbix/GIS respeita a role do operador vinculada através do token temporário.
                      </p>
                    </div>
                    <div className="bg-slate-950 p-4 rounded-xl border border-white/5">
                      <div className="font-bold text-slate-300 mb-2">Notificações Zabbix</div>
                      <p className="text-xs text-slate-500">
                    ...
                    <div className="bg-slate-950 p-4 rounded-xl border border-white/5">
                      <div className="font-bold text-slate-300 mb-2">IA Gateway (Copilot)</div>
                      <p className="text-xs text-slate-500">
                  ...
                  <div className="mt-6 pt-6 border-t border-white/10">
                    <button 
                      ...
                      className="px-4 py-2 border border-slate-700 hover:border-white text-slate-300 text-sm font-bold rounded-lg transition-colors"
                    >
