          ...
          {activeTab === 'tools' && (
            <div className="max-w-5xl mx-auto h-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {tools.map(tool => (
                  <div key={tool.id} onClick={() => showToast('Abrindo configuração de automação')} className="bg-slate-900 border border-white/5 rounded-2xl p-5 hover:border-indigo-500/30 transition-all group cursor-pointer">
          ...
          {activeTab === 'channels' && (
            <div className="max-w-4xl mx-auto h-full space-y-4">
              <div className="flex justify-between items-center mb-2">
                <div>
                  <h2 className="text-lg font-bold text-white font-outfit">Estratégia Omnichannel & Automações MaIA</h2>
                  <p className="text-xs text-slate-400">Portal do Cliente como canal principal de notificação e cobrança; WhatsApp 24h sob IA com transição humana livre.</p>
                </div>
              </div>
              
              {/* CANAL 1: PORTAL DO CLIENTE (CANAL PRINCIPAL) */}
              <div onClick={() => showToast('Acessando integração...')} className="bg-slate-900 border border-blue-500/30 rounded-3xl p-6 flex flex-col md:flex-row gap-6 items-center hover:border-blue-500/50 transition-all bg-gradient-to-r from-blue-950/20 via-slate-900 to-slate-900 cursor-pointer">
                ...
                <div className="flex-1">
                  <div className="flex flex-wrap items-center gap-2 mb-1">
                    <h3 className="text-base font-bold text-white">Portal do Assinante PWA (Canal Principal)</h3>
              ...
              <div onClick={() => showToast('Acessando integração...')} className="bg-slate-900 border border-emerald-500/30 rounded-3xl p-6 flex flex-col md:flex-row gap-6 items-center hover:border-emerald-500/50 transition-all bg-gradient-to-r from-emerald-950/20 via-slate-900 to-slate-900 cursor-pointer">
                ...
                <div className="flex-1">
                  <div className="flex flex-wrap items-center gap-2 mb-1">
                    <h3 className="text-base font-bold text-white">WhatsApp Cloud API (WABA Oficial)</h3>
              ...
              <div onClick={() => showToast('Acessando integração...')} className="bg-slate-900 border border-white/5 rounded-3xl p-6 flex flex-col md:flex-row gap-6 items-center hover:border-indigo-500/30 transition-all cursor-pointer">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className="text-base font-bold text-white">Telefonia & Voz (Asterisk 20+ AMI/ARI)</h3>
                    <span className="bg-slate-800 text-slate-400 text-[10px] font-bold px-2 py-0.5 rounded-full border border-white/10">PRONTO</span>
                  </div>
