...
export default function Helpers() {
 ...
 id: 'visao-geral',
 category: 'core',
 title: 'Visão Geral & Arquitetura do DJD',
 badge: 'Arquitetura Core',
 icon: <LayoutDashboard size={18} />,
 tags: ['arquitetura', 'full-stack', 'express', 'react', 'soberania', 'vps', 'gemini', 'mock'],
 summary: 'Estrutura técnica e propósito do Núcleo de Atendimento ao Provedor (DJD) para ISPs.',
 content: (
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-bold text-foreground mb-2">Núcleo de Atendimento ao Provedor (DJD)</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 O <strong>DJD</strong> é uma plataforma SaaS Omnichannel de missão crítica desenvolvida sob medida para <strong>Provedores de Internet (ISPs)</strong>. Projetado para rodar em uma VM/VPS Debian 12 dedicada por provedor, o DJD garante isolamento completo dos dados cadastrais, financeiros e de telefonia do assinante.
 </p>
 </div>
 ...
 <span className="text-muted-foreground block text-[10px]">Porta 3000</span>
 <span className="text-foreground font-bold">DJD Web / API</span>
 <span className="text-muted-foreground text-[10px] block mt-1">Nginx Reverse Proxy</span>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border">
 <span className="text-muted-foreground block text-[10px]">Porta 7547 / 7557</span>
 <span className="text-emerald-400 font-bold">GenieACS TR-069</span>
 <span className="text-muted-foreground text-[10px] block mt-1">NBI / CWMP ONUs</span>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border">
 <span className="text-muted-foreground block text-[10px]">Porta 5060 / 8089</span>
 <span className="text-indigo-400 font-bold">Asterisk SIP / WSS</span>
 <span className="text-muted-foreground text-[10px] block mt-1">WebRTC Webphone</span>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border">
 <span className="text-muted-foreground block text-[10px]">Porta 10050 / 10051</span>
 <span className="text-cyan-400 font-bold">Zabbix 7.0 LTS</span>
 <span className="text-muted-foreground text-[10px] block mt-1">Triggers & Telemetria</span>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border">
 <span className="text-muted-foreground block text-[10px]">Porta 10000:20000</span>
 <span className="text-purple-400 font-bold">RTP Audio VoIP</span>
 <span className="text-muted-foreground text-[10px] block mt-1">Voz das Ligações</span>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border">
 <span className="text-muted-foreground block text-[10px]">Porta 3799</span>
 <span className="text-amber-400 font-bold">Radius PoD / CoA</span>
 <span className="text-muted-foreground text-[10px] block mt-1">Kick MikroTik / BNG</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <span className="text-muted-foreground font-mono text-[11px]">#0a50ff / Blue 600</span>
 </div>
 <div className="p-2.5 rounded-xl bg-background border border-border flex items-center justify-between">
 <span className="text-foreground font-medium flex items-center gap-2">
 <span className="w-3 h-3 rounded-full bg-[#55b0ff] shrink-0" /> Realce Sky / Ciano
 </span>
 <span className="text-muted-foreground font-mono text-[11px]">#55b0ff</span>
 </div>
 <div className="p-2.5 rounded-xl bg-background border border-border flex items-center justify-between">
 <span className="text-foreground font-medium flex items-center gap-2">
 <span className="w-3 h-3 rounded-full bg-[#1b2c4c] shrink-0" /> Bordas Estruturais
 </span>
 <span className="text-muted-foreground font-mono text-[11px]">#1b2c4c (Escuro) / #e2e8f0 (Claro)</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-bold text-foreground mb-2">CRM 360 & Base de Assinantes (`/admin/crm`)</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 ...
 <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider">Total de Assinantes</span>
 <div className="text-xl font-bold text-foreground font-mono">1.482</div>
 <span className="text-[10px] text-blue-400">Base consolidada no ERP</span>
 </div>
 <div className="p-4 bg-background border border-emerald-500/20 rounded-2xl space-y-1">
 <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider">Clientes Ativos</span>
 ...
 <div className="p-4 bg-background border border-rose-500/20 rounded-2xl space-y-1">
 <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider">Bloqueados / Débito</span>
 ...
 <div className="p-4 bg-background border border-amber-500/20 rounded-2xl space-y-1">
 <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider">Desbloqueio Ativo</span>
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-bold text-foreground mb-2">Kanban Operacional & Gestão de Demandas (`/admin/kanban`)</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 ...
 {/* 3 Pipelines */}
 <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
 <div className="p-4 bg-background border border-blue-500/20 rounded-2xl space-y-2">
 ...
 <div className="p-4 bg-background border border-emerald-500/20 rounded-2xl space-y-2">
 ...
 <div className="p-4 bg-background border border-rose-500/20 rounded-2xl space-y-2">
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-bold text-foreground mb-2">Conectores de Gestão Telecom (Multi-ERP)</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 O DJD possui uma camada de abstração com suporte aos principais sistemas de gestão do mercado telecom brasileiro. Você pode alternar o ERP ativo com um único clique em <strong>Configurações &gt; Conectores ERP</strong>.
 </p>
 </div>

 {/* Cards dos 3 Principais ERPs Homologados */}
 <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
 <div className="p-4 bg-background border border-blue-500/20 rounded-2xl space-y-2.5">
 ...
 <h3 className="text-sm font-bold text-foreground">IXC Soft (IXC Provedor)</h3>
 <p className="text-xs text-muted-foreground leading-relaxed">
 ...
 <div className="p-4 bg-background border border-cyan-500/20 rounded-2xl space-y-2.5">
 <div className="flex items-center justify-between">
 ...
 <h3 className="text-sm font-bold text-foreground">Hubsoft Telecom</h3>
 <p className="text-xs text-muted-foreground leading-relaxed">
 ...
 <div className="p-4 bg-background border border-rose-500/20 rounded-2xl space-y-2.5">
 <div className="flex items-center justify-between">
 ...
 <h3 className="text-sm font-bold text-foreground">MikWeb</h3>
 <p className="text-xs text-muted-foreground leading-relaxed">
 ...
 <p className="text-xs text-muted-foreground leading-relaxed">
 O DJD inclui um <strong>Validador em Tempo Real</strong> na aba de ERP para testar a comunicação antes de colocar a integração em produção:
 </p>
 ...
 <li>Clique em <strong>"Salvar e Ativar"</strong> para definir o ERP como fonte de verdade ativa no DJD.</li>
 </ol>
 </div>
 </div>
 )
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-bold text-foreground mb-2">Inbox Omnichannel & Triagem com Cérebro IA</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 ...
 <div>
 <strong className="text-foreground">Gerar Chave PIX:</strong>
 <span className="text-muted-foreground block text-[11px]">Gera payload Copia-e-Cola e QR Code dinâmico da fatura aberta.</span>
 </div>
 </div>
 <div className="p-2.5 rounded-xl bg-background border border-border flex items-center gap-2">
 <ShieldCheck size={14} className="text-amber-400 shrink-0" />
 <div>
 <strong className="text-foreground">Desbloqueio em Confiança (24h):</strong>
 <span className="text-muted-foreground block text-[11px]">Envia webhook para o ERP e comando ao MikroTik liberando o acesso.</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-bold text-foreground mb-2">Telefonia Asterisk Nativa (`/admin/telefonia`)</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 O DJD possui seu <strong>próprio motor Asterisk 20+ puro e nativo</strong> rodando no backend. Toda a parametrização de protocolos (AMI, ARI, PJSIP, WSS) já nasce pré-configurada. Você não precisa instalar um PABX externo — o DJD já é o PABX.
 </p>
 ...
 <p className="text-xs text-muted-foreground leading-relaxed">
 Quando o assinante disca para a central, o Asterisk 20+ envia o evento AMI com o número de origem (CallerID). O DJD consulta a base cadastral do ERP e abre instantaneamente a <strong>Ficha CRM 360</strong> do cliente na tela do operador antes mesmo do ramal ser atendido. Durante a chamada, o áudio é transcrito em tempo real com avaliação contínua do sentimento do cliente.
 </p>
 </div>
 </div>
 )
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-bold text-foreground mb-2">Centro de Operações de Rede - NOC (`/admin/infra`)</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 ...
 <span className="text-muted-foreground text-[10px] font-bold uppercase">1. Seleção</span>
 <p className="text-muted-foreground font-medium">Operador clica no botão Reconhecer no card do incidente.</p>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border space-y-1">
 <span className="text-muted-foreground text-[10px] font-bold uppercase">2. Nota Técnica</span>
 <p className="text-muted-foreground font-medium">Insere o nome do técnico responsável e o parecer preliminar.</p>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border space-y-1">
 <span className="text-muted-foreground text-[10px] font-bold uppercase">3. Zabbix RPC</span>
 <p className="text-muted-foreground font-medium">Backend despacha método <code>event.acknowledge</code> para o Zabbix.</p>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border space-y-1">
 <span className="text-muted-foreground text-[10px] font-bold uppercase">4. Auditoria LGPD</span>
 <p className="text-muted-foreground font-medium">Evento gravado no livro de conformidade e segurança da plataforma.</p>
 </div>
 </div>
 </div>
 ...
 <div className="p-3 bg-background rounded-xl border border-border flex flex-col sm:flex-row sm:items-center justify-between gap-2">
 <div>
 <span className="text-emerald-400 font-bold mr-2">GET</span>
 <span className="text-muted-foreground">/api/zabbix/triggers</span>
 <p className="text-[11px] text-muted-foreground font-sans mt-0.5">Retorna lista consolidada de triggers ativos e reconhecidos com severidade e host.</p>
 </div>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border flex flex-col sm:flex-row sm:items-center justify-between gap-2">
 <div>
 <span className="text-emerald-400 font-bold mr-2">GET</span>
 <span className="text-muted-foreground">/api/zabbix/traffic</span>
 <p className="text-[11px] text-muted-foreground font-sans mt-0.5">Telemetria de tráfego agregado de borda, PTT/IX.br, CDNs e trânsito IP.</p>
 </div>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border flex flex-col sm:flex-row sm:items-center justify-between gap-2">
 <div>
 <span className="text-blue-400 font-bold mr-2">POST</span>
 <span className="text-muted-foreground">/api/zabbix/ack</span>
 <p className="text-[11px] text-muted-foreground font-sans mt-0.5">Registra reconhecimento de trigger no Zabbix e trilha de auditoria do DJD.</p>
 </div>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border flex flex-col sm:flex-row sm:items-center justify-between gap-2">
 <div>
 <span className="text-purple-400 font-bold mr-2">POST</span>
 <span className="text-muted-foreground">/api/zabbix/test-trigger</span>
 <p className="text-[11px] text-muted-foreground font-sans mt-0.5">Simulador de triggers para testes e homologação controlada da equipe NOC.</p>
 </div>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border flex flex-col sm:flex-row sm:items-center justify-between gap-2">
 <div>
 <span className="text-emerald-400 font-bold mr-2">GET</span>
 <span className="text-muted-foreground">/api/zabbix/health</span>
 <p className="text-[11px] text-muted-foreground font-sans mt-0.5">Health check de conectividade e handshake com a API JSON-RPC do Zabbix.</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-bold text-foreground mb-2">Logística: Estoque & Gestão de Frota (`/admin/estoque`)</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 ...
 <h2 className="text-xl font-bold text-foreground mt-2 mb-2">Contratos SCM, Comodato e Assinatura Digital do Assinante</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 O DJD integra um visualizador e formalizador de contratos digitais de Serviço de Comunicação Multimídia (SCM). O assinante pode realizar o aceite formal diretamente pelo Portal PWA, e o operador pode consultar o termo e reenviá-lo via WhatsApp no CRM/SGP.
 </p>
 </div>
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-bold text-foreground mb-2">Mapa de Rede Georreferenciado GIS (`/admin/mapa-rede`)</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-bold text-foreground mb-2">Telemetria CPE via TR-069 (GenieACS)</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 O módulo <strong>GenieACS</strong> do DJD conecta-se à API NBI (Northbound Interface) do servidor GenieACS na porta <code>7557</code> para diagnosticar remotamente os parâmetros físicos do equipamento do cliente.
 </p>
 </div>

 <div className="p-4 bg-background border border-border rounded-2xl space-y-3">
 <h3 className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Parâmetros Monitorados em Tempo Real:</h3>
 <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 text-xs">
 <div className="p-3 bg-background rounded-xl border border-border">
 <span className="text-muted-foreground block text-[10px]">Potência Óptica RX</span>
 <span className="text-emerald-400 font-mono font-bold">-21.4 dBm</span>
 <span className="text-muted-foreground text-[10px] block mt-1">Normal (-18 a -24 dBm)</span>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border">
 <span className="text-muted-foreground block text-[10px]">Potência Óptica TX</span>
 <span className="text-blue-400 font-mono font-bold">+2.1 dBm</span>
 <span className="text-muted-foreground text-[10px] block mt-1">Dentro dos parâmetros</span>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border">
 <span className="text-muted-foreground block text-[10px]">Temperatura do Laser</span>
 <span className="text-amber-400 font-mono font-bold">44.2 °C</span>
 <span className="text-muted-foreground text-[10px] block mt-1">Faixa operacional segura</span>
 </div>
 </div>
 </div>
 ...
 <h4 className="text-foreground font-semibold text-sm mb-2">Provisionamento</h4>
 ...
 {/* Passo 2 */}
 <div className="p-4 bg-card/50 rounded-2xl border border-border relative overflow-hidden group hover:border-emerald-500/30 transition-all">
 ...
 <h4 className="text-foreground font-semibold text-sm mb-2">Discover (Call Home)</h4>
 <p className="text-muted-foreground text-[11px] leading-relaxed">
 ...
 {/* Passo 3 */}
 <div className="p-4 bg-card/50 rounded-2xl border border-border relative overflow-hidden group hover:border-amber-500/30 transition-all">
 ...
 <h4 className="text-foreground font-semibold text-sm mb-2">Vínculo ERP (SGP)</h4>
 <p className="text-muted-foreground text-[11px] leading-relaxed">
 ...
 {/* Passo 4 */}
 <div className="p-4 bg-card/50 rounded-2xl border border-border relative overflow-hidden group hover:border-fuchsia-500/30 transition-all">
 ...
 <h4 className="text-foreground font-semibold text-sm mb-2">A Mágica do DJD</h4>
 <p className="text-muted-foreground text-[11px] leading-relaxed">
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-bold text-foreground mb-2">Portal do Cliente PWA (`/portal`)</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-bold text-foreground mb-2">Módulo Técnico de Campo Mobile-First (`/admin/campo`)</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-bold text-foreground mb-2">Hierarquia RBAC & Recuperação de Desastres</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 O controle de acesso ao DJD é governado por uma matriz rígida de 4 perfis de usuários com restrições por rota e visibilidade de dados.
 </p>
 </div>

 <div className="space-y-3">
 <h3 className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Níveis de Acesso:</h3>
 ...
 <p className="text-muted-foreground">Acesso irrestrito a configurações, parametrização de ERP, Disaster Recovery, gestão de planos e usuários.</p>
 </div>
 <div className="p-3.5 bg-background border border-border rounded-xl space-y-1">
 <span className="text-blue-400 font-bold font-mono">2. Operador de Atendimento</span>
 <p className="text-muted-foreground">Acesso ao Inbox Omnichannel, Kanban de Suporte/Vendas/Cobrança, Webphone e consulta à Ficha 360 do assinante.</p>
 </div>
 <div className="p-3.5 bg-background border border-border rounded-xl space-y-1">
 <span className="text-emerald-400 font-bold font-mono">3. Técnico NOC (N1/N2)</span>
 <p className="text-muted-foreground">Acesso a telemetria GenieACS, dashboard de rede, ferramentas de ping/tracert e suporte técnico avançado.</p>
 </div>
 <div className="p-3.5 bg-background border border-border rounded-xl space-y-1">
 <span className="text-amber-400 font-bold font-mono">4. Técnico de Campo</span>
 <p className="text-muted-foreground">Acesso exclusivo ao módulo mobile-first de Ordens de Serviço (`/admin/campo`) com rastreamento GPS.</p>
 </div>
 </div>
 </div>
 ...
 <div className="p-2.5 bg-background border border-border rounded-xl flex-1 text-muted-foreground flex items-center justify-between">
 <span>GET /api/backup</span>
 <span className="text-[10px] text-muted-foreground">Download snapshot JSON</span>
 </div>
 <div className="p-2.5 bg-background border border-border rounded-xl flex-1 text-muted-foreground flex items-center justify-between">
 <span>POST /api/restore</span>
 <span className="text-[10px] text-muted-foreground">Upload e importação de base</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <h2 className="text-xl font-bold text-foreground mt-2 mb-2">Trilha Forense e Auditoria de Ações dos Operadores</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 ...
 <p className="text-xs text-muted-foreground leading-relaxed">
 Cada log gerado no DJD possui um identificador único com hash criptográfico SHA-256 que atesta a inviolabilidade do registro perante perícias de segurança ou auditorias do Encarregado de Dados (DPO):
 </p>
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs font-mono">
 <div className="p-3 bg-background rounded-xl border border-border">
 <span className="text-muted-foreground block text-[10px]">Exportação CSV</span>
 <span className="text-foreground font-bold">GET /api/auditoria/exportar?formato=csv</span>
 <p className="text-[10px] text-muted-foreground mt-1">Compatível com Excel, PowerBI e relatórios de auditoria interna.</p>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border">
 <span className="text-muted-foreground block text-[10px]">Exportação JSON Forense</span>
 <span className="text-foreground font-bold">GET /api/auditoria/exportar?formato=json</span>
 <p className="text-[10px] text-muted-foreground mt-1">Exportação bruta com metadados e certificado de conformidade.</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-bold text-foreground mb-2">Perguntas Frequentes (FAQ)</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 ...
 2. Cheque se o firewall do seu servidor de ERP permite conexões de entrada originadas pelo IP da VPS do DJD.<br />
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-bold text-foreground mb-2">Deploy, Infraestrutura & Topologia de Produção</h2>
 <p className="text-muted-foreground text-sm leading-relaxed">
 O <strong>DJD</strong> adota uma topologia <strong>Single-Tenant por ISP</strong>, garantindo total isolamento da base de dados, troncos de telefonia SIP Asterisk e telemetria de rede TR-069 e Zabbix.
 </p>
 </div>

 {/* Cards dos 2 Métodos de Implantação */}
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="p-5 bg-background border border-emerald-500/20 rounded-2xl space-y-3">
 <div className="flex items-center justify-between">
 ...
 <pre className="p-3 bg-background rounded-xl text-xs font-mono text-emerald-300 overflow-x-auto border border-border">
 {`git clone <REPO_URL> nap-isp\ncd nap-isp\nchmod +x deploy.sh\n./deploy.sh`}
 </pre>
 <button
 type="button"
 onClick={() => handleCopyCode(`git clone <REPO_URL> nap-isp\ncd nap-isp\nchmod +x deploy.sh\n./deploy.sh`, 'cmd-deploy-sh')}
 className="absolute top-2 right-2 px-2 py-1 bg-white/10 hover:bg-white/20 text-muted-foreground text-[10px] font-bold rounded-lg transition-all"
 >
 ...
 <div className="p-5 bg-background border border-blue-500/20 rounded-2xl space-y-3">
 <div className="flex items-center justify-between">
 ...
 <p className="text-xs text-muted-foreground leading-relaxed">
 Sobe a stack completa isolada em containers: Aplicação DJD (porta 3000), PostgreSQL 16 (porta 5432), MongoDB para GenieACS (27017), Redis (6379) e serviços GenieACS TR-069.
 </p>
 <div className="relative group">
 <pre className="p-3 bg-background rounded-xl text-xs font-mono text-blue-300 overflow-x-auto border border-border">
 ...
 className="px-2.5 py-1 bg-white/5 hover:bg-accent text-muted-foreground text-[11px] font-bold rounded-lg border border-border flex items-center gap-1"
 >
 ...
 <pre className="p-3 bg-background rounded-xl text-xs font-mono text-muted-foreground overflow-x-auto border border-border">
...
server {
 ...
 <span className="text-muted-foreground">Ativação e SSL:</span>
 <code className="bg-background px-2 py-1 rounded text-cyan-300 font-mono">sudo ln -s /etc/nginx/sites-available/nap.conf /etc/nginx/sites-enabled/</code>
 <code className="bg-background px-2 py-1 rounded text-cyan-300 font-mono">sudo certbot --nginx -d nap.meuprovedor.com.br</code>
 </div>
 </div>
 ...
 <tbody className="divide-y divide-white/5 text-muted-foreground font-mono text-[11px]">
 <tr>
 <td className="py-2 px-3 text-cyan-400 font-bold">3000/tcp</td>
 <td className="py-2 px-3 font-sans">DJD App</td>
 <td className="py-2 px-3 font-sans text-muted-foreground">Aplicação Full-Stack (Node.js + Vite PWA)</td>
 <td className="py-2 px-3 text-muted-foreground font-sans">Localhost / Nginx</td>
 </tr>
 <tr>
 <td className="py-2 px-3 text-emerald-400 font-bold">80/tcp e 443/tcp</td>
 <td className="py-2 px-3 font-sans">Nginx</td>
 <td className="py-2 px-3 font-sans text-muted-foreground">Acesso seguro HTTPS, PWA e Webchat</td>
 ...
 <td className="py-2 px-3 font-sans text-muted-foreground">Sinalização WebRTC para Webphone do operador</td>
 <td className="py-2 px-3 text-muted-foreground font-sans">Navegador / Operador</td>
 </tr>
 <tr>
 <td className="py-2 px-3 text-blue-400 font-bold">5060/udp</td>
 <td className="py-2 px-3 font-sans">Asterisk SIP</td>
 <td className="py-2 px-3 font-sans text-muted-foreground">Troncos SIP das operadoras VoIP e ramais</td>
 ...
 <td className="py-2 px-3 font-sans text-muted-foreground">Fluxo contínuo de áudio e voz das ligações</td>
 <td className="py-2 px-3 text-muted-foreground font-sans">Internet / Operadoras</td>
 </tr>
 <tr>
 <td className="py-2 px-3 text-amber-400 font-bold">7547/tcp</td>
 <td className="py-2 px-3 font-sans">GenieACS CWMP</td>
 <td className="py-2 px-3 font-sans text-muted-foreground">Telemetria TR-069 e gerência das ONUs</td>
 <td className="py-2 px-3 text-muted-foreground font-sans">Rede de Acesso (VLAN de Gerência)</td>
 </tr>
 <tr>
 <td className="py-2 px-3 text-muted-foreground font-bold">3005/tcp</td>
 <td className="py-2 px-3 font-sans">GenieACS UI</td>
 <td className="py-2 px-3 font-sans text-muted-foreground">Painel administrativo do TR-069</td>
 ...
 <td className="py-2 px-3 font-sans text-muted-foreground">Coleta de telemetria local pelo Zabbix Server</td>
 <td className="py-2 px-3 text-muted-foreground font-sans">IP do Zabbix Server</td>
 </tr>
 </tbody>
 </table>
 </div>
 ...
 <div className="p-5 bg-background border border-emerald-500/20 rounded-2xl space-y-4">
 <div className="flex items-center justify-between">
 ...
 <p className="text-muted-foreground text-[11px]">Chave do Google GenAI para orquestração da triagem autônoma e agente de voz.</p>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border space-y-1">
 <span className="text-emerald-400 font-mono font-bold">SGP_URL / APP / TOKEN</span>
 <p className="text-muted-foreground text-[11px]">Credenciais do ERP para emissão de PIX, leitura de faturas e desbloqueio em confiança.</p>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border space-y-1">
 <span className="text-cyan-400 font-mono font-bold">ZABBIX_URL / TOKEN</span>
 <p className="text-muted-foreground text-[11px]">Endpoint JSON-RPC e Token de autenticação da central NOC Zabbix 7.0 LTS.</p>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border space-y-1">
 <span className="text-amber-400 font-mono font-bold">GENIEACS_URL / USER / PASSWORD</span>
 <p className="text-muted-foreground text-[11px]">API Northbound (NBI) para telemetria de sinal óptico, Wi-Fi e reboot remoto de ONUs.</p>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border space-y-1">
 <span className="text-indigo-400 font-mono font-bold">ASTERISK_HOST / ARI / AMI</span>
 <p className="text-muted-foreground text-[11px]">Host local do Asterisk, portas 8088/5038/8089 e segredos para telefonia e Webphone.</p>
 </div>
 <div className="p-3 bg-background rounded-xl border border-border space-y-1">
 <span className="text-emerald-400 font-mono font-bold">MAPA_TILE_URL / DARK_TILE</span>
 <p className="text-muted-foreground text-[11px]">Camadas de azulejos (tiles) OpenStreetMap e CARTO Dark para mapas GIS offline e online.</p>
 </div>
 </div>
 </div>
 ...
 <div>
 <span className="text-muted-foreground text-[10px] block font-sans">API Central:</span>
 ...
 className="px-2 py-1 bg-white/5 hover:bg-accent text-muted-foreground text-[10px] font-bold rounded"
 >
 ...
 <div className="p-3 bg-background rounded-xl border border-border flex items-center justify-between">
 <div>
 <span className="text-muted-foreground text-[10px] block font-sans">NOC Zabbix API:</span>
 ...
 <div className="p-3 bg-background rounded-xl border border-border flex items-center justify-between">
 <div>
 <span className="text-muted-foreground text-[10px] block font-sans">Logs em Tempo Real:</span>
 ...
 <div className="p-3 bg-background rounded-xl border border-border flex items-center justify-between">
 <div>
 <span className="text-muted-foreground text-[10px] block font-sans">Monitor de Recursos:</span>
 ...
 return (
 <div id="pagina-base-de-ajuda" className="h-[calc(100vh-64px)] flex flex-col bg-background overflow-hidden text-card-foreground font-sans">
 
 {/* Topo do Módulo de Ajuda: Título, Busca & Filtros Rápidos */}
 <div className="p-5 border-b border-border bg-card/90 backdrop-blur-md shrink-0 space-y-3">
 <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
 <div>
 <h1 className="text-lg font-bold text-foreground flex items-center gap-2 font-outfit">
 ...
 className="w-full pl-9 pr-3 py-2 bg-background border border-border rounded-xl text-xs text-foreground placeholder-slate-500 outline-none focus:ring-2 focus:ring-[#0a50ff]/30 focus:border-[#0a50ff] transition-all font-medium"
 />
 {searchQuery && (
 <button
 type="button"
 onClick={() => setSearchQuery('')}
 className="absolute right-2.5 top-1/2 -translate-y-1/2 text-[10px] text-muted-foreground hover:text-foreground px-1.5 py-0.5 rounded bg-white/5"
 >
 Limpar
 </button>
 )}
 ...
 <div className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground px-2 flex items-center justify-between">
 ...
 isSelected
 ? 'bg-card border-[#0a50ff] shadow-md shadow-[#0a50ff]/10 ring-1 ring-[#0a50ff]/30'
 : 'bg-card/60 border-border hover:border-[#0a50ff]/40 text-muted-foreground hover:text-card-foreground'
 }`}
 >
 <div className={`mt-0.5 p-2 rounded-xl shrink-0 transition-colors ${
 isSelected ? 'bg-[#0a50ff] text-white' : 'bg-white/5 text-muted-foreground'
 }`}>
 {sec.icon}
 </div>
 ...
 <p className="text-[11px] text-muted-foreground mt-1 line-clamp-1 leading-normal">
 {sec.summary}
 </p>
 </div>
 </button>
 ...
 <HelpCircle size={24} className="mx-auto mb-2 text-muted-foreground" />
 ...
 <div className="flex-1 bg-card border border-border rounded-3xl overflow-y-auto p-6 md:p-8 relative shadow-2xl">
 {/* Header do Artigo */}
 <div className="pb-6 mb-6 border-b border-border flex flex-col sm:flex-row sm:items-center justify-between gap-4">
 ...
 <h2 className="text-xl md:text-2xl font-bold text-foreground mt-1 font-outfit">
 {activeSection.title}
 </h2>
 </div>
 </div>
 ...
 className="px-3 py-1.5 bg-white/5 hover:bg-accent text-muted-foreground rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 border border-border"
