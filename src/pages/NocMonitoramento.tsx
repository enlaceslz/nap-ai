...
export default function NocMonitoramento() {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-slate-950 text-slate-300 overflow-hidden font-sans">
      ...
      {/* HEADER DO NOC */}
      <div className="px-6 py-4 border-b border-white/5 bg-slate-900/80 backdrop-blur-md flex flex-wrap justify-between items-center gap-4 z-10">
        <div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button 
            ...
            className="flex items-center gap-2 px-3.5 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-xl transition-colors border border-white/10 text-xs font-bold"
          ...
          <button 
            ...
            className="p-2 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-xl transition-colors border border-white/10" 
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-slate-900 border border-white/5 rounded-2xl p-5 relative overflow-hidden group">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Tráfego Borda</span>
              </div>
              <p className="text-3xl font-bold text-white font-outfit mb-1">
                {peakTraffic} <span className="text-sm text-slate-500 font-normal">Gbps</span>
              </p>
              <div className="flex items-center justify-between text-xs mt-2 pt-2 border-t border-white/5">
                ...
                <span className="text-slate-500">CDNs: 45%</span>
              </div>
            </div>
            ...
            <div className="bg-slate-900 border border-white/5 rounded-2xl p-5 relative overflow-hidden group">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">OLTs & Roteadores</span>
              </div>
              <p className="text-3xl font-bold text-white font-outfit mb-1">
                {onlineCount} <span className="text-sm text-slate-500 font-normal">/ {nodes.length} Ativos</span>
              </p>
              <div className="flex items-center justify-between text-xs mt-2 pt-2 border-t border-white/5">
                <span className="text-slate-400 font-medium">Huawei, ZTE, Datacom, FH</span>
            ...
            <div className="bg-slate-900 border border-white/5 rounded-2xl p-5 relative overflow-hidden group">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Triggers (Zabbix)</span>
              </div>
              <p className="text-3xl font-bold text-white font-outfit mb-1">
                {totalUnack} <span className="text-sm text-slate-500 font-normal">Pendentes</span>
              </p>
              <div className="flex items-center justify-between text-xs mt-2 pt-2 border-t border-white/5">
                <span className="text-red-400 font-bold uppercase tracking-wider">
                  {criticalUnack} Crítico{criticalUnack !== 1 ? 's' : ''} (Unack)
                </span>
                <span className="text-slate-500">Total: {alarms.length}</span>
              </div>
            </div>
            ...
            <div className="bg-slate-900 border border-white/5 rounded-2xl p-5 relative overflow-hidden group">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">ONTs Atendidas</span>
              </div>
              <p className="text-3xl font-bold text-white font-outfit mb-1">
                {totalOnus.toLocaleString('pt-BR')} <span className="text-sm text-slate-500 font-normal">CPEs</span>
              </p>
              <div className="flex items-center justify-between text-xs mt-2 pt-2 border-t border-white/5">
                <span className="text-slate-400">96 Portas PON Ativas</span>
          ...
          <div className="bg-slate-900 border border-white/5 rounded-2xl p-6 shadow-xl">
            <div className="flex flex-wrap justify-between items-center gap-4 mb-6">
              ...
              <div className="flex flex-wrap items-center gap-3">
                {/* Seletor de Camadas */}
                <div className="flex items-center bg-slate-950 p-1 rounded-xl border border-white/5 text-xs font-semibold">
                  <button 
                    onClick={() => setTrafficLayer('total')}
                    className={`px-3 py-1.5 rounded-lg transition-all ${
                      trafficLayer === 'total' ? 'bg-cyan-500 text-slate-950 font-bold shadow' : 'text-slate-400 hover:text-white'
                    }`}
                  >
                    Total Agregado
                  </button>
                  <button 
                    ...
                    className={`px-3 py-1.5 rounded-lg transition-all ${
                      trafficLayer === 'ixbr' ? 'bg-indigo-500 text-white font-bold shadow' : 'text-slate-400 hover:text-white'
                    }`}
                  >
                    PTT / IX.br
                  </button>
                  <button 
                    ...
                    className={`px-3 py-1.5 rounded-lg transition-all ${
                      trafficLayer === 'cdn' ? 'bg-purple-500 text-white font-bold shadow' : 'text-slate-400 hover:text-white'
                    }`}
                  >
                    CDNs Locais
                  </button>
                  <button 
                    ...
                    className={`px-3 py-1.5 rounded-lg transition-all ${
                      trafficLayer === 'transit' ? 'bg-amber-500 text-slate-950 font-bold shadow' : 'text-slate-400 hover:text-white'
                    }`}
                  >
                    Trânsito IP
                  </button>
                ...
                <div className="flex items-center bg-slate-950 p-1 rounded-xl border border-white/5 text-xs font-semibold">
                  <button 
                    ...
                    className={`px-3 py-1.5 rounded-lg transition-all ${
                      trafficRange === 'today' ? 'bg-slate-800 text-cyan-300 font-bold' : 'text-slate-400 hover:text-white'
                    }`}
                  >
                    Hoje
                  </button>
                  <button 
                    ...
                    className={`px-3 py-1.5 rounded-lg transition-all ${
                      trafficRange === '7d' ? 'bg-slate-800 text-cyan-300 font-bold' : 'text-slate-400 hover:text-white'
                    }`}
                  >
                    7 Dias
                  </button>
                  <button 
                    ...
                    className={`px-3 py-1.5 rounded-lg transition-all ${
                      trafficRange === '30d' ? 'bg-slate-800 text-cyan-300 font-bold' : 'text-slate-400 hover:text-white'
                    }`}
                  >
                    30 Dias
                  </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 bg-slate-900 border border-white/5 rounded-2xl overflow-hidden shadow-xl flex flex-col">
              <div className="p-5 border-b border-white/5 bg-slate-900/60 space-y-3">
                <div className="flex flex-wrap justify-between items-center gap-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs bg-slate-800 text-slate-300 font-mono px-2 py-0.5 rounded-full border border-white/5">
                      {filteredAlarms.length} encontrados
                    </span>
                  </div>

                  {/* Filtro ACK / UNACK */}
                  <div className="flex items-center gap-1 bg-slate-950 p-0.5 rounded-lg border border-white/5 text-[11px] font-bold">
                    <button
                      onClick={() => setAckFilter('all')}
                      className={`px-2.5 py-1 rounded-md transition-colors ${ackFilter === 'all' ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white'}`}
                    >
                      Todos
                    </button>
                    <button
                      onClick={() => setAckFilter('unack')}
                      className={`px-2.5 py-1 rounded-md transition-colors ${ackFilter === 'unack' ? 'bg-red-500/20 text-red-300 border border-red-500/30' : 'text-slate-400 hover:text-white'}`}
                    >
                      Não Reconhecidos ({totalUnack})
                    </button>
                    <button
                      onClick={() => setAckFilter('ack')}
                      className={`px-2.5 py-1 rounded-md transition-colors ${ackFilter === 'ack' ? 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/30' : 'text-slate-400 hover:text-white'}`}
                    >
                      Reconhecidos
                    </button>
                  </div>
                ...
                <div className="flex flex-wrap items-center gap-2 pt-1">
                  <div className="relative flex-1 min-w-[200px]">
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-950 border border-white/10 rounded-xl pl-9 pr-3 py-1.5 text-xs text-white placeholder-slate-500 outline-none focus:border-cyan-500 font-medium"
                    />
                  </div>
                  ...
                  <select
                    ...
                    className="bg-slate-950 border border-white/10 rounded-xl px-3 py-1.5 text-xs text-slate-300 outline-none focus:border-cyan-500 font-medium"
                  >
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-3 max-h-[520px]">
                {filteredAlarms.length === 0 ? (
                  <div className="text-center py-12 text-slate-500">
                    ...
                    <p className="text-sm font-semibold text-slate-400">Nenhum alerta pendente com os filtros selecionados.</p>
                    <p className="text-xs text-slate-500 mt-1">Infraestrutura operando dentro dos parâmetros de telemetria.</p>
                  </div>
                ) : (
                          ...
                          <div className="shrink-0 flex items-center gap-2">
                            {!alarm.ack ? (
                              <button
                                ...
                                className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 hover:text-white text-slate-300 text-xs font-bold rounded-lg transition-colors border border-white/10 flex items-center gap-1.5"
            ...
            <div className="lg:col-span-5 bg-slate-900 border border-white/5 rounded-2xl overflow-hidden shadow-xl flex flex-col">
              <div className="p-5 border-b border-white/5 bg-slate-900/60 flex justify-between items-center">
                <div>
                  <h3 className="font-bold text-base text-white font-outfit flex items-center gap-2">
                    <Server size={18} className="text-indigo-400" />
                    Chassis OLT & Roteadores de Borda
                  </h3>
                  <p className="text-xs text-slate-400 mt-0.5">Telemetria de CPU, Temperatura e Portas PON</p>
                </div>
                ...
                {nodes.map((node) => {
                  ...
                  return (
                    <div 
                      ...
                      className="p-4 bg-slate-950/80 hover:bg-slate-950 border border-white/10 hover:border-cyan-500/40 rounded-xl transition-all cursor-pointer group"
                    >
                      <div className="flex justify-between items-start gap-2 mb-2">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            ...
                            <p className="text-[11px] font-mono text-slate-500">{node.ip} • {node.model || 'GPON'}</p>
                          </div>
                        </div>
                      ...
                      <div className="grid grid-cols-3 gap-3 pt-2 text-xs border-t border-white/5">
                        <div>
                          <div className="flex justify-between text-[11px] mb-1">
                            ...
                            <span className={`font-mono font-bold ${isHighCpu ? 'text-red-400' : 'text-slate-300'}`}>{node.cpu}%</span>
                          </div>
                        ...
                        <div>
                          <div className="flex justify-between text-[11px] mb-1">
                            ...
                            <span className="font-mono font-bold text-slate-300">{node.ram}%</span>
                          </div>
                          <div className="w-full h-1.5 bg-slate-800 rounded-full overflow-hidden">
                        ...
                        <div>
                          <div className="flex justify-between text-[11px] mb-1">
                            <span className="text-slate-400 flex items-center gap-1">
                              <Thermometer size={11} className={isHighTemp ? 'text-red-400' : 'text-slate-400'} /> Temp
                            </span>
                            <span className={`font-mono font-bold ${isHighTemp ? 'text-red-400' : 'text-slate-300'}`}>{node.temp}°C</span>
                          </div>
                          <div className="w-full h-1.5 bg-slate-800 rounded-full overflow-hidden">
                      ...
                      <div className="flex justify-between items-center text-[11px] text-slate-400 mt-2.5 pt-2 border-t border-white/5">
                        <span>
      ...
      {selectedHost && (
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex justify-end">
          <div className="w-full max-w-lg bg-slate-900 border-l border-white/10 h-full overflow-y-auto p-6 flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <div className="flex justify-between items-start pb-4 border-b border-white/10">
                <div>
                  ...
                  <h2 className="text-xl font-bold text-white font-outfit mt-2">
                    {selectedHost.name}
                  </h2>
                  <p className="text-xs font-mono text-slate-400 mt-0.5">IP: {selectedHost.ip} • Uptime: {selectedHost.uptime}</p>
                </div>
                <button 
              ...
              <div className="space-y-3 text-xs">
                <h4 className="font-bold text-slate-200 uppercase tracking-wider text-[11px]">Infraestrutura & Instalação</h4>
                <div className="bg-slate-950 p-4 rounded-xl border border-white/5 space-y-2">
                  <div className="flex justify-between">
                    <span className="text-slate-500">Localização POP:</span>
                    <span className="text-slate-200 font-medium">{selectedHost.location || 'POP Central'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-500">Alimentação Elétrica:</span>
                    <span className="text-emerald-400 font-medium">{selectedHost.powerSupply || 'Dual AC/DC'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-500">Ventoinhas / Fan Tray:</span>
                    <span className="text-slate-200 font-mono">{selectedHost.fanRpm || 4200} RPM (Normal)</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-500">Capacidade de Uplink:</span>
              ...
              {selectedHost.ponPorts > 0 && (
                <div className="space-y-3 text-xs">
                  <h4 className="font-bold text-slate-200 uppercase tracking-wider text-[11px]">Distribuição GPON (PON Slots)</h4>
                  <div className="bg-slate-950 p-4 rounded-xl border border-white/5 space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-slate-400">Total de Portas PON:</span>
                      <span className="text-white font-bold font-mono">{selectedHost.ponPorts} Portas Class C+</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-400">ONTs Sincronizadas:</span>
                      <span className="text-emerald-400 font-bold font-mono">{selectedHost.activeOnus} ONTs Online</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-400">Potência Tx Média OLT:</span>
                      <span className="text-cyan-400 font-mono">+4.8 dBm (Excelente)</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-400">Sinal Rx Médio na OLT:</span>
                      <span className="text-slate-300 font-mono">-19.4 dBm (Padrão Anatel)</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              {/* Status de Sensores */}
              <div className="space-y-3 text-xs">
                <h4 className="font-bold text-slate-200 uppercase tracking-wider text-[11px]">Sensores SNMP em Tempo Real</h4>
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-slate-950 p-3 rounded-xl border border-white/5">
                    <span className="text-slate-500 block">CPU Load</span>
                    <span className="text-base font-bold text-white font-mono">{selectedHost.cpu}%</span>
                  </div>
                  <div className="bg-slate-950 p-3 rounded-xl border border-white/5">
                    <span className="text-slate-500 block">Memória RAM</span>
                    <span className="text-base font-bold text-white font-mono">{selectedHost.ram}%</span>
                  </div>
                  <div className="bg-slate-950 p-3 rounded-xl border border-white/5">
                    <span className="text-slate-500 block">Temperatura do Chassi</span>
                    <span className="text-base font-bold text-emerald-400 font-mono">{selectedHost.temp}°C</span>
                  </div>
                  <div className="bg-slate-950 p-3 rounded-xl border border-white/5">
                    <span className="text-slate-500 block">Estado Operacional</span>
      ...
      {ackModalProblem && (
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-white/10 rounded-2xl w-full max-w-md p-6 space-y-4 shadow-2xl animate-in zoom-in-95">
            <div className="flex justify-between items-start">
              ...
              <button onClick={() => setAckModalProblem(null)} className="text-slate-400 hover:text-white">
                <X size={18} />
              </button>
            </div>

            <div className="bg-slate-950 p-3 rounded-xl border border-white/5 text-xs text-slate-300">
              <p className="font-bold text-slate-200">{ackModalProblem.message}</p>
              <span className="text-[11px] text-slate-500 mt-1 block">Severidade: {ackModalProblem.severity}</span>
            </div>

            <form onSubmit={handleConfirmAck} className="space-y-3 text-xs">
              <div>
                <label className="block text-slate-400 font-bold mb-1">Nome do Operador / Técnico</label>
                <input 
                  type="text"
                  value={ackAuthor}
                  onChange={(e) => setAckAuthor(e.target.value)}
                  required
                  className="w-full bg-slate-950 border border-white/10 rounded-xl px-3 py-2 text-white outline-none focus:border-cyan-500"
                />
              </div>

              <div>
                <label className="block text-slate-400 font-bold mb-1">Nota Técnica de Reconhecimento</label>
                <textarea 
                  value={ackNote}
                  onChange={(e) => setAckNote(e.target.value)}
                  placeholder="Ex: Equipe de fusão em deslocamento para o POP. Janela emergencial aberta."
                  rows={3}
                  className="w-full bg-slate-950 border border-white/10 rounded-xl px-3 py-2 text-white outline-none focus:border-cyan-500 resize-none"
                />
              </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-white/10 rounded-2xl w-full max-w-md p-6 space-y-4 shadow-2xl animate-in zoom-in-95">
            ...
            <form onSubmit={handleTriggerSimulation} className="space-y-3 text-xs">
              <div>
                <label className="block text-slate-400 font-bold mb-1">Host / OLT Alvo</label>
                <select
                  value={simHostId}
                  onChange={(e) => setSimHostId(Number(e.target.value))}
                  className="w-full bg-slate-950 border border-white/10 rounded-xl px-3 py-2 text-white outline-none focus:border-amber-500 font-medium"
                >
                  {nodes.map(n => (
              ...
              <div>
                <label className="block text-slate-400 font-bold mb-1">Severidade do Alerta</label>
                <select
                  value={simSeverity}
              ...
              <div>
                <label className="block text-slate-400 font-bold mb-1">Mensagem do Incidente</label>
                <input 
                  type="text"
                  value={simMessage}
      ...
      {showConfigModal && (
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-white/10 rounded-2xl w-full max-w-lg p-6 space-y-4 shadow-2xl animate-in zoom-in-95">
            <div className="flex justify-between items-start">
              <div>
                <h3 className="font-bold text-lg text-white font-outfit flex items-center gap-2">
            ...
            <div className="space-y-3 text-xs">
              <div className="bg-slate-950 p-4 rounded-xl border border-white/5 space-y-2 font-mono">
                <div className="flex justify-between">
                  <span className="text-slate-500">Versão do Servidor:</span>
                  <span className="text-emerald-400 font-bold">{health?.version || config.zabbix?.versao || 'Zabbix Server 7.0.3 LTS'}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500">Endpoint JSON-RPC:</span>
                  <span className="text-slate-300">{health?.endpoint || config.zabbix?.urlJsonRpc || 'http://127.0.0.1:8080/zabbix/api_jsonrpc.php'}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500">Porta Agent / Trapper:</span>
                  <span className="text-slate-300">{config.zabbix?.portaAgent || 10050} / TCP</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500">Latência da API:</span>
                  <span className="text-cyan-400 font-bold">{health?.latencyMs || 14} ms (Tempo Real)</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500">Itens Monitorados:</span>
                  <span className="text-slate-300">1.428 métricas ativas</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500">Frequência de Polling:</span>
                  <span className="text-amber-400 font-bold">5 segundos (Daemon nativo)</span>
                </div>
              </div>

              <div className="p-3 bg-white/5 rounded-xl border border-white/5 text-[11px] text-slate-400 leading-relaxed">
