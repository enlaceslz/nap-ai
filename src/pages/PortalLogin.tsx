...
export default function PortalLogin() {
 ...
 Não encontramos nenhum contrato para o CPF <strong className="text-muted-foreground">{cpf}</strong>.
 </p>
 ...
 <h3 className="text-foreground font-bold text-lg mb-1 relative z-10">Quer ser cliente DJD?</h3>
 ...
 className="w-full bg-card text-blue-700 hover:bg-blue-50 font-bold py-3 rounded-xl transition-all shadow-md active:scale-95 flex items-center justify-center gap-2 relative z-10"
 >
 ...
 className="w-full bg-slate-100 hover:bg-slate-200 text-muted-foreground font-bold py-3.5 rounded-xl transition-all active:scale-95"
 >
 Tentar outro CPF
 </button>
 </div>
 ...
 <span className="bg-card px-3 text-muted-foreground font-bold uppercase tracking-wider">
 ...
 : 'bg-background/80 border-border hover:border-blue-200 hover:bg-slate-100/70'
 }`}
 >
 <div className="flex items-start justify-between gap-3">
 <div className="min-w-0 flex-1">
 <div className="flex items-center gap-2 mb-1">
 <span className="font-bold text-sm text-foreground truncate font-outfit">
 {cliente.nome}
 </span>
 ...
 <span>CPF: <strong className="text-muted-foreground">{cliente.cpf}</strong></span>
 <span>•</span>
 ...
 className="text-xs font-bold text-muted-foreground hover:text-blue-600 flex items-center gap-1.5 mx-auto transition-colors"
 >
 <Info size={14} />
 ...
 {showDetails && (
 <div className="mt-3 p-4 bg-background rounded-2xl border border-border text-xs text-muted-foreground space-y-2.5 animate-in fade-in">
 <div className="flex justify-between items-center pb-2 border-b border-border">
 <span className="font-bold text-foreground text-sm">{selectedClient.nome}</span>
 <span className="font-mono text-muted-foreground">Contrato: {selectedClient.contrato}</span>
 </div>
 <div className="grid grid-cols-2 gap-2">
 <div>
 <span className="text-muted-foreground block text-[10px] uppercase font-bold">Endereço</span>
 <span className="font-medium text-muted-foreground">{selectedClient.endereco}</span>
 </div>
 <div>
 <span className="text-muted-foreground block text-[10px] uppercase font-bold">Bairro / Cidade</span>
 <span className="font-medium text-muted-foreground">{selectedClient.bairro} - {selectedClient.cidade}/{selectedClient.uf}</span>
 </div>
 <div>
 <span className="text-muted-foreground block text-[10px] uppercase font-bold">ONU / Roteador (TR-069)</span>
 <span className="font-medium text-muted-foreground">{selectedClient.cpe.modelo}</span>
 </div>
 <div>
 <span className="text-muted-foreground block text-[10px] uppercase font-bold">Sinal Óptico RX</span>
 <span className="font-medium text-emerald-600 font-mono">{selectedClient.cpe.rxPower} (Normal)</span>
 </div>
 <div>
 <span className="text-muted-foreground block text-[10px] uppercase font-bold">Rede Wi-Fi 5GHz</span>
 <span className="font-medium text-muted-foreground font-mono">{selectedClient.cpe.ssid5}</span>
 </div>
 <div>
 <span className="text-muted-foreground block text-[10px] uppercase font-bold">Senha do Wi-Fi</span>
 <span className="font-medium text-muted-foreground font-mono">{selectedClient.cpe.senhaWifi}</span>
 </div>
 </div>
