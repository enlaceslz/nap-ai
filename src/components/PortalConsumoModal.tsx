...
export default function PortalConsumoModal({
 ...
 default: return <Radio size={15} className="text-muted-foreground" />;
 }
 };
 ...
 <div className="bg-card border border-border rounded-3xl w-full max-w-xl p-6 shadow-2xl relative overflow-hidden flex flex-col max-h-[90vh]">
 {/* Header */}
 ...
 <div>
 <h3 className="font-bold text-foreground text-base font-outfit">Extrato de Consumo de Banda</h3>
 ...
 <span className="text-xs text-muted-foreground font-mono">Consultando telemetria do concentrador BNG...</span>
 </div>
 ) : (
 ...
 {/* Total Geral */}
 <div className="bg-background border border-border rounded-2xl p-3.5">
 <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground block mb-1">
 Tráfego Total
 </span>
 <div className="text-lg md:text-xl font-black font-outfit text-foreground">
 ...
 <span className="text-[10px] text-muted-foreground font-mono mt-0.5 block">84% do tráfego</span>
 </div>
 ...
 <span className="text-[10px] text-muted-foreground font-mono mt-0.5 block">16% do tráfego</span>
 </div>
 </div>
 ...
 <span className="text-[10px] text-muted-foreground font-mono">Em Gigabytes (GB)</span>
 </div>
 ...
 <span className="text-[10px] text-muted-foreground font-mono">Telemetria TR-069</span>
 </div>
 ...
 <span className="text-muted-foreground font-medium truncate">{dev.nome}</span>
 </div>
 ...
 <span className="font-mono text-foreground font-bold text-right w-16">
 {dev.consumoGB} GB
 </span>
 </div>
 </div>
 ...
 {/* Footer */}
 <div className="pt-4 mt-2 border-t border-border flex items-center justify-end shrink-0">
 <button
 onClick={onClose}
