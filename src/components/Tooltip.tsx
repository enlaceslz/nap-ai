...
export function Tooltip({ content, children, position = 'top', className = '' }: TooltipProps) {
 ...
 <div className="bg-muted text-foreground text-[10px] font-bold px-2.5 py-1.5 rounded-lg shadow-xl whitespace-nowrap border border-border flex flex-col items-center">
 {content}
