    ...
    <div id="checklist-homologacao-container" className="space-y-6 text-slate-200">
      ...
      <div className="p-6 bg-slate-950 border border-white/5 rounded-3xl space-y-6 shadow-xl">
        ...
        <div className="space-y-3">
          ...
          <div className="w-full h-3.5 bg-slate-950 rounded-full overflow-hidden p-0.5 border border-white/10 relative">
            <div 
        ...
        <div className="flex items-center gap-2">
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 bg-slate-950 border border-white/10 rounded-xl text-xs text-white placeholder-slate-500 outline-none focus:border-blue-500 transition-all"
            />
          </div>
        ...
        {itensFiltrados.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isExpandido && (
                <div className="p-4 sm:p-5 bg-slate-950 border-t border-white/5 rounded-b-2xl space-y-4 text-xs">
