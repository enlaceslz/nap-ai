...
export const PWAInstallButton: React.FC = () => {
 ...
 <div className="w-full max-w-sm rounded-3xl bg-card p-6 border border-border relative">
 <button 
 ...
 <h3 className="text-xl font-bold text-foreground font-outfit mb-3">Instalar no iPhone</h3>
 <p className="mt-2 text-sm text-muted-foreground leading-relaxed mb-4">
 Para instalar o Portal DJD no seu dispositivo:
 <br /><br />
 ...
 <button
 onClick={() => setShowIOSGuide(false)}
 className="w-full rounded-xl bg-slate-100 py-3 text-sm font-bold text-foreground hover:bg-slate-200 transition-all"
 >
 Entendi
 </button>
 </div>
