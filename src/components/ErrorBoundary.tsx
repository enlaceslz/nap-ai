...
export default class ErrorBoundary extends React.Component<Props, State> {
 ...
 <div className="max-w-md w-full bg-[#101726] border border-border rounded-2xl p-8 text-center shadow-2xl space-y-6">
 ...
 {this.state.error && (
 <div className="p-3 bg-background border border-border rounded-xl text-left text-xs font-mono text-rose-400 overflow-x-auto max-h-24">
 ...
 <a
 href="/"
 className="flex-1 bg-white/5 hover:bg-accent text-muted-foreground font-bold py-2.5 px-4 rounded-xl text-sm transition-all flex items-center justify-center gap-2 border border-border"
 >
 <Home size={15} />
 <span>Início</span>
 </a>
