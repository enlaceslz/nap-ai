...
export default function AddressMapModal({
 ...
 const lat = enderecoAtual.coordenadas?.lat ?? -2.5297;
 const lng = enderecoAtual.coordenadas?.lng ?? -44.3028;
...
_Enviado via DJD Telecom (SGP / CRM Integrado)_`;
 };
 ...
 return (
 <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-card/60 backdrop-blur-xs animate-in fade-in">
 <div 
 className="bg-card rounded-3xl border border-border w-full max-w-4xl max-h-[92vh] flex flex-col overflow-hidden animate-in zoom-in-95"
 onClick={(e) => e.stopPropagation()}
 >
 {/* Header do Modal */}
 <div className="p-5 sm:p-6 border-b border-border bg-background/70 flex items-center justify-between">
 ...
 <h3 className="text-base sm:text-lg font-bold text-foreground font-outfit">
 ...
 <button
 onClick={onClose}
 className="w-8 h-8 rounded-full border border-border hover:bg-slate-200 text-muted-foreground hover:text-card-foreground flex items-center justify-center transition-colors"
 >
 ✕
 </button>
 </div>
 ...
 className="w-full pl-10 pr-4 py-2.5 bg-card border border-border rounded-xl text-xs sm:text-sm text-card-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-blue-600/30 focus:border-blue-600 font-mono "
 />
 </div>
 <button
 type="button"
 ...
 <label className="block text-[11px] font-semibold text-muted-foreground mb-1">Logradouro (Rua / Av)</label>
 <input 
 type="text"
 ...
 className="w-full px-3 py-2 bg-background border border-border rounded-xl text-xs text-card-foreground focus:bg-card focus:outline-none focus:border-blue-600"
 />
 </div>
 <div>
 <label className="block text-[11px] font-semibold text-muted-foreground mb-1">Número</label>
 <input 
 type="text"
 ...
 <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
 <div>
 <label className="block text-[11px] font-semibold text-muted-foreground mb-1">Bairro</label>
 <input 
 type="text"
 ...
 <div>
 <label className="block text-[11px] font-semibold text-muted-foreground mb-1">Cidade</label>
 <input 
 type="text"
 ...
 <div>
 <label className="block text-[11px] font-semibold text-muted-foreground mb-1">UF</label>
 <input 
 type="text"
 ...
 placeholder="SP"
 maxLength={2}
 className="w-full px-3 py-2 bg-background border border-border rounded-xl text-xs text-card-foreground uppercase focus:bg-card focus:outline-none focus:border-blue-600"
 />
 </div>
 </div>
 ...
 <span className="text-[10px] font-normal text-muted-foreground">Crucial para visitas e rotas</span>
 </label>
 <input
 type="text"
 ...
 className="w-full px-3 py-2 bg-amber-500/10 border border-amber-500/30 rounded-xl text-xs text-card-foreground focus:bg-card focus:outline-none focus:border-amber-500 font-medium"
 />
 </div>
 ...
 <span className="text-muted-foreground font-medium">Coordenadas:</span>
 <span className="font-mono font-bold text-muted-foreground bg-muted px-2 py-0.5 rounded border border-border">
 ...
 disabled={salvando}
 className="px-3.5 py-1.5 bg-muted hover:bg-card text-foreground rounded-lg text-xs font-bold flex items-center gap-1.5 transition-colors disabled:opacity-50"
 >
 ...
 <div>
 <h4 className="font-bold text-sm text-foreground font-outfit">Enviar para o Técnico</h4>
 <p className="text-[11px] text-muted-foreground">Compartilhar via WhatsApp com 1 clique</p>
 </div>
 </div>
 ...
 className="w-full py-2 px-4 bg-card hover:bg-background border border-border text-muted-foreground rounded-xl text-xs font-semibold flex items-center justify-center gap-2 transition-colors "
 >
 ...
 <span className="text-xs font-bold text-card-foreground">Visualização Integrada (OpenStreetMap)</span>
 ...
 <div className="relative w-full h-64 sm:h-80 bg-muted z-0">
 <MapContainer 
 center={[lat, lng]} 
 zoom={14} 
 ...
 <div className="absolute bottom-3 left-3 bg-card/95 backdrop-blur-xs border border-border px-3 py-2 rounded-xl max-w-xs text-xs pointer-events-none z-[400]">
 <p className="font-bold text-foreground truncate">{enderecoAtual.nome || 'Local de Instalação'}</p>
 <p className="text-[11px] text-muted-foreground truncate">{enderecoAtual.endereco}</p>
 {pontoReferencia && (
 ...
 {/* Footer */}
 <div className="p-4 sm:p-5 border-t border-border bg-background/70 flex items-center justify-between">
 ...
 type="button"
 onClick={onClose}
 className="px-5 py-2 bg-slate-200 hover:bg-slate-300 text-card-foreground rounded-xl text-xs font-bold transition-colors"
 >
 Fechar
 </button>
 </div>
