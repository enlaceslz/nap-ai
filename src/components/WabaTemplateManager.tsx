...
export default function WabaTemplateManager() {
  ...
  return (
    <div className="bg-slate-900 border border-white/5 rounded-2xl p-6 text-slate-100 shadow-xl space-y-6">
      {/* Cabeçalho do Módulo */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {templates.map(tpl => {
              ...
              return (
                <div
                  key={tpl.id}
                  className="bg-slate-950 border border-white/5 rounded-xl p-4 flex flex-col justify-between hover:border-emerald-500/30 transition-all group"
                >
                  <div className="space-y-3">
                    ...
                    <div className="bg-slate-900/80 border border-white/5 rounded-lg p-2.5 text-[11px] text-slate-300 font-mono line-clamp-3 leading-relaxed">
                      {headerComp?.text && (
                    ...
                    {btnComp?.buttons && btnComp.buttons.length > 0 && (
                      <div className="flex flex-wrap gap-1.5">
                        {btnComp.buttons.map((b, idx) => (
                          <span
                            key={idx}
                            className="text-[10px] font-medium bg-white/5 border border-white/5 px-2 py-0.5 rounded text-slate-300"
                          >
                            {b.text}
                          </span>
                        ))}
      ...
      {activeTab === 'editor' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 space-y-5">
            ...
            <div className="bg-slate-950 border border-white/5 rounded-xl p-4 flex items-center justify-between gap-4">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Índice de Conformidade Meta:</span>
                  <span
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 bg-slate-950 border border-white/5 rounded-xl text-xs font-mono font-bold text-white outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-600"
                />
                <span className="text-[10px] text-slate-500 mt-1 block">Apenas minúsculas e _ (sem espaços).</span>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2.5 bg-slate-950 border border-white/5 rounded-xl text-xs font-bold text-white outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-600"
                >
                ...
                {editHeaderType === 'TEXT' && (
                  <div>
                    <input
                      ...
                      className="w-full p-2.5 bg-slate-900 border border-white/5 rounded-xl text-xs font-medium text-white outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-600"
                    />
            ...
            <div className="bg-slate-950 border border-white/5 rounded-xl p-4 space-y-3">
              ...
              <textarea
                ...
                className="w-full p-3 bg-slate-900 border border-white/5 rounded-xl text-xs font-mono text-white outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-600 leading-relaxed"
              />
            ...
            <div className="bg-slate-950 border border-white/5 rounded-xl p-4 space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] text-slate-500">{editFooterText.length}/60</span>
              </div>
              <input
                type="text"
                maxLength={60}
            ...
            <div className="bg-slate-950 border border-white/5 rounded-xl p-4 space-y-3">
              <div className="flex items-center justify-between">
                ...
                {editButtons.length < 3 && (
                  <button
                    ...
                    className="px-2.5 py-1 bg-white/5 hover:bg-white/10 text-slate-300 border border-white/5 rounded-lg text-xs font-bold transition-colors flex items-center gap-1"
                  >
                    <Plus size={13} />
              ...
              {editButtons.length === 0 ? (
                <p className="text-xs text-slate-500 italic">Nenhum botão configurado.</p>
              ) : (
                <div className="space-y-2.5">
                  {editButtons.map((btn, index) => (
                    <div key={index} className="flex flex-col sm:flex-row items-center gap-2 bg-slate-900 p-2.5 rounded-lg border border-white/5">
                      <select
                        value={btn.type}
                        onChange={e => {
                        ...
                        className="p-1.5 bg-slate-950 border border-white/5 rounded-md text-xs font-bold text-white"
                      >
                      ...
                      <input
                        ...
                        className="flex-1 p-1.5 bg-slate-950 border border-white/5 rounded-md text-xs text-white"
                      />
                      ...
                      {btn.type === 'URL' && (
                        <input
                          ...
                          className="flex-1 p-1.5 bg-slate-950 border border-white/5 rounded-md text-xs text-white font-mono"
                        />
                      )}
                  ...
                  {validationResults.uniqueVars.map(v => (
                    <div key={v}>
                      ...
                      <input
                        ...
                        className="w-full p-2 bg-slate-900 border border-white/5 rounded-lg text-xs text-white outline-none focus:border-emerald-600"
                      />
                    </div>
                  ))}
                </div>
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            <div className="bg-slate-950 border border-white/5 rounded-2xl p-4 shadow-2xl">
              <div className="flex items-center justify-between border-b border-white/5 pb-3 mb-3">
                <div className="flex items-center gap-2">
                  <Smartphone size={16} className="text-emerald-400" />
                  <span className="text-xs font-bold text-white font-outfit">Simulador WhatsApp Oficial</span>
                </div>
                <div className="flex items-center gap-1 bg-slate-900 p-1 rounded-lg border border-white/5">
                  <button
                    ...
                    className={`px-2 py-0.5 rounded text-[10px] font-bold ${
                      previewMode === 'sample' ? 'bg-emerald-600 text-white' : 'text-slate-400 hover:text-white'
                    }`}
                  >
                    Com Amostras
                  </button>
                  <button
                    ...
                    className={`px-2 py-0.5 rounded text-[10px] font-bold ${
                      previewMode === 'variables' ? 'bg-emerald-600 text-white' : 'text-slate-400 hover:text-white'
                    }`}
                  >
                    Variáveis ({'{{n}}'})
                  </button>
              ...
              <div className="bg-[#0b141a] rounded-xl p-4 min-h-[380px] border border-white/5 flex flex-col justify-between relative overflow-hidden">
                ...
                <div className="bg-[#005c4b] text-slate-100 rounded-lg p-3 max-w-[95%] shadow-md space-y-2 relative ml-auto">
                  {/* Cabeçalho */}
                  {editHeaderType === 'TEXT' && editHeaderText && (
                    <div className="font-bold text-xs text-white pb-1 border-b border-white/10">
                      {editHeaderText}
                    </div>
                  )}
                  ...
                  {/* Rodapé e Hora */}
                  <div className="flex items-center justify-between pt-1 text-[10px] text-slate-300/80">
                ...
                {editButtons.length > 0 && (
                  <div className="mt-2 space-y-1.5 max-w-[95%] ml-auto">
                    {editButtons.map((btn, i) => (
                      <div
                        key={i}
                        className="bg-slate-900 hover:bg-slate-900 text-sky-400 font-bold text-xs py-2 px-3 rounded-lg text-center shadow transition-colors flex items-center justify-center gap-1.5 cursor-pointer border border-white/5"
                      >
              ...
              <div className="mt-4 pt-3 border-t border-white/5 space-y-2">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 p-2 bg-slate-900 border border-white/5 rounded-xl text-xs font-mono text-white outline-none"
                  />
                  <button
                    type="button"
      ...
      {activeTab === 'guidelines' && (
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {/* Card UTILITY */}
            <div className="bg-slate-950 border border-blue-500/20 rounded-xl p-5 space-y-3">
            ...
            {/* Card MARKETING */}
            <div className="bg-slate-950 border border-amber-500/20 rounded-xl p-5 space-y-3">
          ...
          <div className="bg-slate-950 border border-white/5 rounded-xl p-5 space-y-4">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-white/5 hover:bg-white/10 text-slate-300 border border-white/5 rounded-xl text-xs font-bold transition-colors flex items-center gap-1.5"
            >
          ...
          <pre className="bg-slate-950 p-4 rounded-xl border border-white/5 text-xs font-mono text-emerald-300 overflow-x-auto max-h-[450px]">
