...
const ERP_TARGETS: ApiValidationTarget[] = [
 ...
 defaultUrl: 'https://sgp.djdtelecom.com.br/api',
 ...
 defaultUrl: 'https://ixc.djdtelecom.com.br/webservice/v1',
 ...
 defaultUrl: 'https://djdtelecom.hubsoft.com.br/api/v1',
...
export default function ApiValidationCard() {
 ...
 // Salvar e ativar ERP como principal do DJD
 ...
 setActiveSuccessFeedback(`O ${target.nome} foi salvo e ativado como o ERP primário do DJD!`);
 ...
 return (
 <div id="card-utilitario-validacao-erp" className="p-6 md:p-7 rounded-2xl bg-card border border-border shadow-xl space-y-6">
 
 {/* Header do Card Utilitário */}
 <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-border">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center text-foreground shadow-md shadow-blue-500/10">
 ...
 className="text-[10px] text-blue-400 hover:text-blue-300 font-bold flex items-center gap-1 px-2 py-0.5 rounded-lg bg-white/5 hover:bg-accent border border-border transition-all"
 ...
 isSelected
 ? 'bg-background border-blue-500 shadow-lg shadow-blue-500/5 ring-1 ring-blue-500/30 cursor-default'
 : 'bg-background/60 border-border hover:border-border text-muted-foreground hover:text-foreground cursor-pointer'
 }`}
 >
 {/* Linha superior: Ícone, Nome e Badge Ativo */}
 <div className="flex items-center gap-3 w-full">
 <div className={`w-9 h-9 rounded-lg bg-gradient-to-tr ${t.badgeCor} flex items-center justify-center text-foreground font-black text-xs shrink-0 shadow`}>
 {t.sigla}
 </div>
 ...
 <div className="p-3.5 bg-background rounded-xl border border-border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs text-muted-foreground">
 ...
 Endereço base do webservice (HTTPS obrigatório para produção). Exemplo: <code className="text-muted-foreground">{target.defaultUrl}</code>
 </span>
 </div>
 ...
 <span className="text-[11px] text-muted-foreground">Nunca compartilhe esta chave publicamente</span>
 </div>
 <div className="relative">
 <input
 ...
 className="w-full p-2.5 pr-10 bg-background border border-border rounded-xl text-sm font-medium text-foreground outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 font-mono transition-all"
 />
 <button
 type="button"
 ...
 <span className="text-[11px] text-muted-foreground">Parâmetro de identificação</span>
 </div>
 <input
 ...
 <div>
 <span className="text-xs font-bold text-foreground block">Testar Permissão de Desbloqueio em Confiança (24h)</span>
 <span className="text-[11px] text-muted-foreground">Verifica se a API autoriza o comando de reativação temporária para o assinante.</span>
 </div>
 <input
 type="checkbox"
 ...
 className="px-3 py-2 bg-white/5 hover:bg-accent text-muted-foreground hover:text-muted-foreground rounded-xl text-xs font-medium transition-all"
 ...
 className="px-2.5 py-2 text-muted-foreground hover:text-muted-foreground text-xs transition-all"
 >
 Limpar
 </button>
 </div>
 ...
 <span className="px-2 py-1 rounded-lg bg-white/5 text-muted-foreground border border-border text-[11px] font-mono">
 {feedback.versaoDetectada}
 </span>
 )}
 </div>
 ...
 <div>
 <span className="font-bold text-foreground block text-[11px]">{item.item}</span>
 <span className="text-[11px] text-muted-foreground">{item.mensagem}</span>
 </div>
 </div>
 )})}
 </div>
 ...
 <div className="mt-4 p-3.5 rounded-xl bg-black/40 border border-border space-y-2">
 ...
 <span className="text-[10px] text-muted-foreground block">Assinante Teste</span>
 <span className="text-foreground truncate block font-sans">{feedback.exemplo.cliente_exemplo}</span>
 </div>
 <div className="p-2 bg-background rounded-lg border border-border">
 <span className="text-[10px] text-muted-foreground block">Contrato</span>
 <span className="text-blue-400 truncate block">{feedback.exemplo.contrato_codigo}</span>
 </div>
 <div className="p-2 bg-background rounded-lg border border-border">
 <span className="text-[10px] text-muted-foreground block">Sessão PPPoE / IP</span>
 <span className="text-emerald-400 truncate block">{feedback.exemplo.ipv4}</span>
 </div>
 <div className="p-2 bg-background rounded-lg border border-border">
 <span className="text-[10px] text-muted-foreground block">Fatura Aberta</span>
 ...
 Tudo pronto! Você pode salvar estas credenciais e tornar o <strong>{target.nome}</strong> o ERP ativo do DJD.
 </span>
 <button
 type="button"
