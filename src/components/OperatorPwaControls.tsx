...
export default function OperatorPwaControls() {
 ...
 : 'bg-white/5 border-border text-muted-foreground hover:text-foreground hover:bg-accent'
 }`}
 ...
 <div 
 className="bg-card border border-border w-full max-w-lg rounded-3xl p-6 shadow-2xl text-card-foreground relative overflow-hidden"
 ...
 <div>
 <h3 className="font-bold text-foreground text-base font-outfit">Notificações Push & PWA do Operador</h3>
 <p className="text-xs text-muted-foreground">Alertas em tempo real no desktop e mobile, mesmo com a aba minimizada.</p>
 </div>
 </div>
 <button 
 ...
 <div className="p-4 bg-background rounded-2xl border border-border flex flex-col sm:flex-row sm:items-center justify-between gap-3">
 <div className="flex items-center gap-3">
 ...
 <span className="text-[10px] text-muted-foreground">Áudio sintetizado + Vibração</span>
 </div>

 <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
 <button
 onClick={() => handleTest('whatsapp')}
 className="p-2 bg-white/5 hover:bg-emerald-500/10 hover:border-emerald-500/30 border border-border rounded-xl text-[11px] font-medium text-muted-foreground transition-all flex flex-col items-center gap-1 text-center"
 >
 ...
 className="p-2 bg-white/5 hover:bg-blue-500/10 hover:border-blue-500/30 border border-border rounded-xl text-[11px] font-medium text-muted-foreground transition-all flex flex-col items-center gap-1 text-center"
 >
 ...
 className="p-2 bg-white/5 hover:bg-amber-500/10 hover:border-amber-500/30 border border-border rounded-xl text-[11px] font-medium text-muted-foreground transition-all flex flex-col items-center gap-1 text-center"
 >
 ...
 className="p-2 bg-white/5 hover:bg-indigo-500/10 hover:border-indigo-500/30 border border-border rounded-xl text-[11px] font-medium text-muted-foreground transition-all flex flex-col items-center gap-1 text-center"
 >
 ...
 <div>
 <span className="text-xs font-bold text-foreground block">Console do Operador PWA</span>
 <span className="text-[11px] text-muted-foreground block">
...
function CategoryToggle({ icon, title, description, active, onToggle }: CategoryToggleProps) {
 ...
 active ? 'bg-blue-600 border-blue-500 text-white' : 'border-border bg-white/5 text-transparent'
 }`}>
 <Check size={12} />
 </div>
 </button>
