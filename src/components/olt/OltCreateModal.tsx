...
export const OltCreateModal: React.FC<OltCreateModalProps> = ({
 ...
 <div className="bg-card border border-border rounded-2xl w-full max-w-xl p-6 space-y-6 shadow-2xl my-8">
 ...
 className="w-full px-3 py-2 rounded-lg bg-background border border-border text-xs text-card-foreground focus:outline-none focus:border-cyan-500 font-semibold"
 required
 />
 </div>
 ...
 className="w-full px-3 py-2 rounded-lg bg-background border border-border text-xs text-card-foreground focus:outline-none focus:border-cyan-500"
 >
 ...
 className="px-2 py-2 rounded-lg bg-background border border-border text-xs text-card-foreground focus:outline-none focus:border-cyan-500"
 >
 ...
 className="w-20 px-2 py-2 rounded-lg bg-background border border-border text-xs text-card-foreground font-mono focus:outline-none focus:border-cyan-500"
 />
 </div>
 </div>
 </div>
 ...
 placeholder="admin"
 className="w-full px-3 py-1.5 rounded-lg bg-card border border-border text-xs text-card-foreground focus:outline-none focus:border-cyan-500"
 />
 </div>
 ...
 className="w-full px-3 py-1.5 rounded-lg bg-card border border-border text-xs text-card-foreground font-mono focus:outline-none focus:border-cyan-500"
 />
 </div>
 </div>
 ...
 type="submit"
 disabled={submitting}
 className="flex items-center gap-1.5 px-5 py-2 rounded-lg bg-cyan-600 hover:bg-cyan-500 text-foreground text-xs font-semibold transition-colors shadow disabled:opacity-50"
 >
 {submitting ? (
 <>
