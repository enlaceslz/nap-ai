...
export const OnuManagementTab: React.FC<OnuManagementTabProps> = ({
 ...
 <div className="bg-card/60 p-4 rounded-xl border border-border space-y-4">
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-cyan-600 hover:bg-cyan-500 text-foreground text-xs font-semibold transition-colors shadow-sm"
 >
 <UserCheck size={14} />
 ...
 className="w-full pl-9 pr-4 py-2 rounded-lg bg-background border border-border text-xs text-card-foreground placeholder-slate-500 focus:outline-none focus:border-cyan-500 transition-colors"
 />
 </div>
 ...
 statusFilter === 'all' ? 'bg-muted text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'
 }`}
 >
 Todas ({onus.length})
 </button>
 ...
 className={`px-2.5 py-1 rounded font-medium transition-colors ${
 statusFilter === 'online' ? 'bg-emerald-500/20 text-emerald-300' : 'text-muted-foreground hover:text-white'
 }`}
 >
 ...
 className={`px-2.5 py-1 rounded font-medium transition-colors ${
 statusFilter === 'offline' ? 'bg-rose-500/20 text-rose-300' : 'text-muted-foreground hover:text-white'
 }`}
 >
 ...
 className={`px-2.5 py-1 rounded font-medium transition-colors ${
 statusFilter === 'alert' ? 'bg-amber-500/20 text-amber-300' : 'text-muted-foreground hover:text-white'
 }`}
 >
 Sinal Alerta (&lt; -24 dBm)
 </button>
 ...
 className="rounded bg-card border-border text-cyan-500 focus:ring-0 cursor-pointer"
 />
 </th>
 ...
 className="p-1.5 rounded hover:bg-muted text-muted-foreground hover:text-cyan-400 transition-colors"
 >
 <Activity size={14} />
 </button>
 ...
 className="p-1.5 rounded hover:bg-muted text-muted-foreground hover:text-indigo-400 transition-colors"
 >
 <Sparkles size={14} />
 </button>
 ...
 className="p-1.5 rounded hover:bg-muted text-muted-foreground hover:text-amber-400 transition-colors"
 >
 <Power size={14} />
 </button>
 ...
 <div className="p-4 rounded-xl bg-background/80 border border-border text-center">
 <span className="text-[11px] text-muted-foreground block mb-1">Sinal RX na ONU</span>
 ...
 <div className="p-4 rounded-xl bg-background/80 border border-border text-center">
 <span className="text-[11px] text-muted-foreground block mb-1">Sinal TX da ONU</span>
 <span className="text-2xl font-bold font-mono text-emerald-400">
 +{telemetryModal.data.tx_onu} dBm
 </span>
 <div className="mt-1 text-[11px] text-muted-foreground">Potência do Laser</div>
 </div>

 <div className="p-4 rounded-xl bg-background/80 border border-border text-center">
 <span className="text-[11px] text-muted-foreground block mb-1">Distância Óptica</span>
 <span className="text-xl font-bold font-mono text-foreground">
 {telemetryModal.data.distancia_metros} metros
 </span>
 <div className="mt-1 text-[11px] text-muted-foreground">Comprimento da fibra</div>
 </div>

 <div className="p-4 rounded-xl bg-background/80 border border-border text-center">
 <span className="text-[11px] text-muted-foreground block mb-1">Temperatura do Módulo</span>
 <span className="text-xl font-bold font-mono text-amber-400">
 {telemetryModal.data.temperatura}°C
 </span>
 <div className="mt-1 text-[11px] text-muted-foreground">Voltagem: {telemetryModal.data.voltagem_v}V</div>
 </div>
 </div>

 <div className="p-3 rounded-lg bg-background border border-border text-xs text-muted-foreground flex items-center justify-between">
 <span>OLT: <strong className="text-card-foreground">{telemetryModal.onu.olt_nome}</strong></span>
 <span>Porta PON: <strong className="text-cyan-400">{telemetryModal.onu.pon_identifier}</strong></span>
 <span>ONU ID: <strong className="text-card-foreground">{telemetryModal.onu.onu_id}</strong></span>
 </div>

 <div className="flex justify-end pt-2">
 <button
 onClick={() => setTelemetryModal(null)}
 className="px-4 py-2 rounded-lg bg-muted hover:bg-accent text-foreground text-xs font-semibold"
 >
 Fechar
 </button>
 </div>
 ...
 {diagnosticModal && (
 <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 backdrop-blur-sm">
 <div className="bg-card border border-border rounded-2xl w-full max-w-xl p-6 space-y-5 shadow-2xl">
 <div className="flex items-center justify-between border-b border-border pb-3">
 <div>
 <h3 className="font-bold text-foreground text-base flex items-center gap-2">
 ...
 <div className="p-3 rounded-lg bg-background/70 border border-border text-center">
 <span className="text-muted-foreground block mb-1">Ping de Enlace</span>
 ...
 <div className="p-3 rounded-lg bg-background/70 border border-border text-center">
 <span className="text-muted-foreground block mb-1">Latência Média</span>
 <span className="font-bold font-mono text-sm text-cyan-400">
 {diagnosticModal.data.latencia_ms} ms
 </span>
 </div>
 <div className="p-3 rounded-lg bg-background/70 border border-border text-center">
 <span className="text-muted-foreground block mb-1">Perda de Pacotes</span>
 <span className="font-bold font-mono text-sm text-card-foreground">
 ...
 <div
 key={idx}
 className="flex items-center justify-between p-2 rounded bg-background/60 border border-border/80"
 >
