  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="font-mono text-[11px] px-1.5 py-0.5 rounded bg-white/10 text-current border border-white/10 font-bold">
      ...
      {isOpen && (
        <>
          <div 
            ...
            aria-hidden="true" 
          />
          <div className="absolute right-0 top-11 w-64 bg-slate-900 border border-white/10 rounded-2xl shadow-xl z-50 p-2 animate-in fade-in-50 zoom-in-95">
            <div className="px-3 py-2 border-b border-white/10 flex items-center justify-between">
              <span className="text-[11px] font-bold uppercase tracking-wider text-slate-400">Status do Operador</span>
              <span className="text-[10px] text-slate-500 font-mono">NR-17 Compliance</span>
            </div>
            ...
            <div className="mt-1 pt-2 border-t border-white/10 px-3 py-1 bg-white/5 rounded-xl flex items-center justify-between text-[11px] text-slate-400">
